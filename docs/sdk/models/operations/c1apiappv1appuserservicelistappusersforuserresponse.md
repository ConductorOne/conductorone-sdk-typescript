...
| `appUsersForUserServiceListResponse`                                                                          | [shared.AppUsersForUserServiceListResponse](../../../sdk/models/shared/appusersforuserservicelistresponse.md) | :heavy_minus_sign:                                                                                            | The response message for listing app users correlated to a specific C1 user.                                  |