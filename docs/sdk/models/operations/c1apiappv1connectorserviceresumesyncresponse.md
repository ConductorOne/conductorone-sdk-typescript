...
| `resumeSyncResponse`                                                          | [shared.ResumeSyncResponse](../../../sdk/models/shared/resumesyncresponse.md) | :heavy_minus_sign:                                                            | Empty response body. Status code indicates success.                           |