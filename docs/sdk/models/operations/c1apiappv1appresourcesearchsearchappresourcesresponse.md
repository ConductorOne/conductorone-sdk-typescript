...
| `searchAppResourcesResponse`                                                                         | [shared.SearchAppResourcesResponse](../../../sdk/models/shared/searchappresourcesresponse.md)        | :heavy_minus_sign:                                                                                   | The SearchAppResourcesResponse message contains a list of results and a nextPageToken if applicable. |