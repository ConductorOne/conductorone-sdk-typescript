...
| `getUserProfileTypesResponse`                                                                   | [shared.GetUserProfileTypesResponse](../../../sdk/models/shared/getuserprofiletypesresponse.md) | :heavy_minus_sign:                                                                              | GetUserProfileTypesResponse is the response containing the profile types for a user.            |