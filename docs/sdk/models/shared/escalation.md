...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `cancelTicket`                                                                  | [shared.CancelTicket](../../../sdk/models/shared/cancelticket.md)               | :heavy_minus_sign:                                                              | N/A                                                                             |
...
| `skipStep`                                                                      | [shared.SkipStep](../../../sdk/models/shared/skipstep.md)                       | :heavy_minus_sign:                                                              | N/A                                                                             |