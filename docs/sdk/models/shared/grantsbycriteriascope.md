...
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `accessProfileFilter`                                                                     | [shared.GrantAccessProfileFilter](../../../sdk/models/shared/grantaccessprofilefilter.md) | :heavy_minus_sign:                                                                        | N/A                                                                                       |
...
| `grantsAddedBetween`                                                                      | [shared.GrantsAddedBetween](../../../sdk/models/shared/grantsaddedbetween.md)             | :heavy_minus_sign:                                                                        | N/A                                                                                       |
