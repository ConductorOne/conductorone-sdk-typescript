...
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `action`                                                                                  | [shared.TaskTypeActionInput](../../../sdk/models/shared/tasktypeactioninput.md)           | :heavy_minus_sign:                                                                        | N/A                                                                                       |
| `certify`                                                                                 | [shared.TaskTypeCertifyInput](../../../sdk/models/shared/tasktypecertifyinput.md)         | :heavy_minus_sign:                                                                        | N/A                                                                                       |
| `finding`                                                                                 | [shared.TaskTypeFindingInput](../../../sdk/models/shared/tasktypefindinginput.md)         | :heavy_minus_sign:                                                                        | N/A                                                                                       |
