...
```typescript
import { CredentialCompromiseAction } from "conductorone-sdk-typescript/sdk/models/shared";

let value: CredentialCompromiseAction = "SSF_REVOCATION_ACTION_UNSPECIFIED";
