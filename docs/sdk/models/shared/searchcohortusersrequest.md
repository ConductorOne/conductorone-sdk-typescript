...
| `selectedEntitlements`                                                  | [shared.EntitlementRef](../../../sdk/models/shared/entitlementref.md)[] | :heavy_minus_sign:                                                      | Optional list of entitlements to compute per-user coverage for.         |