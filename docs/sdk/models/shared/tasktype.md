...
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `action`                                                                        | [shared.TaskTypeAction](../../../sdk/models/shared/tasktypeaction.md)           | :heavy_minus_sign:                                                              | N/A                                                                             |
| `certify`                                                                       | [shared.TaskTypeCertify](../../../sdk/models/shared/tasktypecertify.md)         | :heavy_minus_sign:                                                              | N/A                                                                             |
| `finding`                                                                       | [shared.TaskTypeFinding](../../../sdk/models/shared/tasktypefinding.md)         | :heavy_minus_sign:                                                              | N/A                                                                             |
