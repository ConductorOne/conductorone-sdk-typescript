...
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `accountFilter`                                                                                   | [shared.AccountFilter](../../../sdk/models/shared/accountfilter.md)                               | :heavy_minus_sign:                                                                                | The AccountFilter message.                                                                        |
| `grantFilter`                                                                                     | [shared.GrantFilter](../../../sdk/models/shared/grantfilter.md)                                   | :heavy_minus_sign:                                                                                | The GrantFilter message.                                                                          |
