...
<!-- UsageSnippet language="typescript" operationID="c1.api.app.v1.AppUsageControlsService.Get" method="get" path="/api/v1/apps/{app_id}/usage_controls" -->
```typescript
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("appUsageControlsGet failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="c1.api.app.v1.AppUsageControlsService.Update" method="post" path="/api/v1/apps/{app_id}/usage_controls" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("appUsageControlsUpdate failed:", res.error);
  }
}
