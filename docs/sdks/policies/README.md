...
<!-- UsageSnippet language="typescript" operationID="c1.api.policy.v1.Policies.List" method="get" path="/api/v1/policies" -->
```typescript
...
async function run() {
  const result = await conductoroneSDKTypescript.policies.list();
...
import { policiesList } from "conductorone-sdk-typescript/funcs/policiesList.js";
...
async function run() {
  const res = await policiesList(conductoroneSDKTypescript);
  if (res.ok) {
...
<!-- UsageSnippet language="typescript" operationID="c1.api.policy.v1.Policies.Create" method="post" path="/api/v1/policies" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { policiesCreate } from "conductorone-sdk-typescript/funcs/policiesCreate.js";
...
async function run() {
  const res = await policiesCreate(conductoroneSDKTypescript);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("policiesCreate failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="c1.api.policy.v1.Policies.Delete" method="delete" path="/api/v1/policies/{id}" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
async function run() {
  const result = await conductoroneSDKTypescript.policies.delete({
    id: "<id>",
  });
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { policiesDelete } from "conductorone-sdk-typescript/funcs/policiesDelete.js";
...
async function run() {
  const res = await policiesDelete(conductoroneSDKTypescript, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("policiesDelete failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="c1.api.policy.v1.Policies.Get" method="get" path="/api/v1/policies/{id}" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { policiesGet } from "conductorone-sdk-typescript/funcs/policiesGet.js";
...
async function run() {
  const res = await policiesGet(conductoroneSDKTypescript, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
<!-- UsageSnippet language="typescript" operationID="c1.api.policy.v1.Policies.Update" method="post" path="/api/v1/policies/{id}" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { policiesUpdate } from "conductorone-sdk-typescript/funcs/policiesUpdate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("policiesUpdate failed:", res.error);
  }
}
