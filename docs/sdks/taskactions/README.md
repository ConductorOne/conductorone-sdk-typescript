...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.Approve" method="post" path="/api/v1/tasks/{task_id}/action/approve" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.ApproveWithStepUp" method="post" path="/api/v1/tasks/{task_id}/action/approve-with-step-up" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.Close" method="post" path="/api/v1/tasks/{task_id}/action/close" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.Comment" method="post" path="/api/v1/tasks/{task_id}/action/comment" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.Deny" method="post" path="/api/v1/tasks/{task_id}/action/deny" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.EscalateToEmergencyAccess" method="post" path="/api/v1/tasks/{task_id}/action/escalate" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.ProcessNow" method="post" path="/api/v1/tasks/{task_id}/action/process" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.Reassign" method="post" path="/api/v1/tasks/{task_id}/action/reassign" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.HardReset" method="post" path="/api/v1/tasks/{task_id}/action/reset" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.Restart" method="post" path="/api/v1/tasks/{task_id}/action/restart" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.SkipStep" method="post" path="/api/v1/tasks/{task_id}/action/skip-step" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.UpdateGrantDuration" method="post" path="/api/v1/tasks/{task_id}/action/update-grant-duration" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
async function run() {
  const result = await conductoroneSDKTypescript.taskActions.updateGrantDuration({
    taskId: "<id>",
  });
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { taskActionsUpdateGrantDuration } from "conductorone-sdk-typescript/funcs/taskActionsUpdateGrantDuration.js";
...
async function run() {
  const res = await taskActionsUpdateGrantDuration(conductoroneSDKTypescript, {
    taskId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("taskActionsUpdateGrantDuration failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.C1ApiTaskV1TaskActionsServiceUpdateGrantDurationRequest](../../sdk/models/operations/c1apitaskv1taskactionsserviceupdategrantdurationrequest.md)                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.C1ApiTaskV1TaskActionsServiceUpdateGrantDurationResponse](../../sdk/models/operations/c1apitaskv1taskactionsserviceupdategrantdurationresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="c1.api.task.v1.TaskActionsService.UpdateRequestData" method="post" path="/api/v1/tasks/{task_id}/action/update-request-data" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
async function run() {
  const result = await conductoroneSDKTypescript.taskActions.updateRequestData({
    taskId: "<id>",
  });
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { taskActionsUpdateRequestData } from "conductorone-sdk-typescript/funcs/taskActionsUpdateRequestData.js";
...
async function run() {
  const res = await taskActionsUpdateRequestData(conductoroneSDKTypescript, {
    taskId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("taskActionsUpdateRequestData failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.C1ApiTaskV1TaskActionsServiceUpdateRequestDataRequest](../../sdk/models/operations/c1apitaskv1taskactionsserviceupdaterequestdatarequest.md)                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.C1ApiTaskV1TaskActionsServiceUpdateRequestDataResponse](../../sdk/models/operations/c1apitaskv1taskactionsserviceupdaterequestdataresponse.md)\>**
