...
<!-- UsageSnippet language="typescript" operationID="c1.api.app.v1.AppResourceOwners.Delete" method="delete" path="/api/v1/apps/{app_id}/resource_types/{resource_type_id}/resource/{resource_id}/ownerids" -->
```typescript
...
async function run() {
  const result = await conductoroneSDKTypescript.appResourceOwners.delete({
    appId: "<id>",
    resourceTypeId: "<id>",
    resourceId: "<id>",
  });
...
import { appResourceOwnersDelete } from "conductorone-sdk-typescript/funcs/appResourceOwnersDelete.js";
...
async function run() {
  const res = await appResourceOwnersDelete(conductoroneSDKTypescript, {
    appId: "<id>",
    resourceTypeId: "<id>",
    resourceId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("appResourceOwnersDelete failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.C1ApiAppV1AppResourceOwnersDeleteRequest](../../sdk/models/operations/c1apiappv1appresourceownersdeleterequest.md)                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.C1ApiAppV1AppResourceOwnersDeleteResponse](../../sdk/models/operations/c1apiappv1appresourceownersdeleteresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="c1.api.app.v1.AppResourceOwners.ListOwnerIDs" method="get" path="/api/v1/apps/{app_id}/resource_types/{resource_type_id}/resource/{resource_id}/ownerids" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
async function run() {
  const result = await conductoroneSDKTypescript.appResourceOwners.listOwnerIDs({
    appId: "<id>",
    resourceTypeId: "<id>",
    resourceId: "<id>",
  });
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { appResourceOwnersListOwnerIDs } from "conductorone-sdk-typescript/funcs/appResourceOwnersListOwnerIDs.js";
...
async function run() {
  const res = await appResourceOwnersListOwnerIDs(conductoroneSDKTypescript, {
    appId: "<id>",
    resourceTypeId: "<id>",
    resourceId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("appResourceOwnersListOwnerIDs failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.C1ApiAppV1AppResourceOwnersListOwnerIDsRequest](../../sdk/models/operations/c1apiappv1appresourceownerslistowneridsrequest.md)                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.C1ApiAppV1AppResourceOwnersListOwnerIDsResponse](../../sdk/models/operations/c1apiappv1appresourceownerslistowneridsresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="c1.api.app.v1.AppResourceOwners.Set" method="put" path="/api/v1/apps/{app_id}/resource_types/{resource_type_id}/resource/{resource_id}/owners" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
...
```typescript
import { ConductoroneSDKTypescriptCore } from "conductorone-sdk-typescript/core.js";
import { appResourceOwnersSet } from "conductorone-sdk-typescript/funcs/appResourceOwnersSet.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("appResourceOwnersSet failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.C1ApiAppV1AppResourceOwnersSetRequest](../../sdk/models/operations/c1apiappv1appresourceownerssetrequest.md)                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.C1ApiAppV1AppResourceOwnersSetResponse](../../sdk/models/operations/c1apiappv1appresourceownerssetresponse.md)\>**
