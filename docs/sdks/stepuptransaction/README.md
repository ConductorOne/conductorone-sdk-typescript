...
<!-- UsageSnippet language="typescript" operationID="c1.api.stepup.v1.StepUpTransactionService.Search" method="post" path="/api/v1/search/step-up/transactions" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="c1.api.stepup.v1.StepUpTransactionService.Get" method="get" path="/api/v1/step-up/transactions/{id}" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
