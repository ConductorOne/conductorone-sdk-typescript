...
Invokes the c1.api.automations.v1.AutomationExecutionSearchService.SearchAllAutomationExecutions method.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="c1.api.automations.v1.AutomationExecutionSearchService.SearchAllAutomationExecutions" method="post" path="/api/v1/search/all_automation_executions" -->
```typescript
...
async function run() {
  const result = await conductoroneSDKTypescript.automationExecutionSearch.searchAllAutomationExecutions();
...
import { automationExecutionSearchSearchAllAutomationExecutions } from "conductorone-sdk-typescript/funcs/automationExecutionSearchSearchAllAutomationExecutions.js";
...
async function run() {
  const res = await automationExecutionSearchSearchAllAutomationExecutions(conductoroneSDKTypescript);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("automationExecutionSearchSearchAllAutomationExecutions failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [shared.SearchAllAutomationExecutionsRequest](../../sdk/models/shared/searchallautomationexecutionsrequest.md)                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.C1ApiAutomationsV1AutomationExecutionSearchServiceSearchAllAutomationExecutionsResponse](../../sdk/models/operations/c1apiautomationsv1automationexecutionsearchservicesearchallautomationexecutionsresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="c1.api.automations.v1.AutomationExecutionSearchService.SearchAutomationExecutions" method="post" path="/api/v1/search/automation_executions" -->
```typescript
import { ConductoroneSDKTypescript } from "conductorone-sdk-typescript";
