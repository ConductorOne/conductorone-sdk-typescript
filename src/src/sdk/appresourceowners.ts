...
export class AppResourceOwners extends ClientSDK {
     ...
     */
    async list(
        input: operations.C1ApiAppV1AppResourceOwnersListRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) =>
                operations.C1ApiAppV1AppResourceOwnersListRequest$.outboundSchema.parse(value$),
        ...
        const pathParams$ = {
            ...
            resource_id: enc$.encodeSimple("resource_id", payload$.resource_id, {
                explode: false,
                charEncoding: "percent",
            }),
            resource_type_id: enc$.encodeSimple("resource_type_id", payload$.resource_type_id, {
                explode: false,
                charEncoding: "percent",
            }),
        };
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.C1ApiAppV1AppResourceOwnersListResponse$.inboundSchema.parse({
                        ...responseFields$,
                        ListAppResourceOwnersResponse: val$,
                    });
                },
