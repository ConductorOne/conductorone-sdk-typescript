...
export class SessionSettings extends ClientSDK {
    ...
    async get(
        ...
        const path$ = this.templateURLComponent("/api/v1/settings/session")();
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.C1ApiSettingsV1SessionSettingsServiceGetResponse$.inboundSchema.parse(
                        {
                            ...responseFields$,
                            GetSessionSettingsResponse: val$,
                        }
                    );
                },
     ...
     */
    async update(
        input: shared.UpdateSessionSettingsRequest | undefined,
        options?: RequestOptions
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) =>
                shared.UpdateSessionSettingsRequest$.outboundSchema.optional().parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.C1ApiSettingsV1SessionSettingsServiceUpdateResponse$.inboundSchema.parse(
                        {
                            ...responseFields$,
                            UpdateSessionSettingsResponse: val$,
                        }
                    );
                },
                "Response validation failed"
