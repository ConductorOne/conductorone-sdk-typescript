...
export class AppReport {
    ...
    async list(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.C1ApiAppV1AppReportServiceListRequest(req);
        }
        ...
        const res: operations.C1ApiAppV1AppReportServiceListResponse =
            new operations.C1ApiAppV1AppReportServiceListResponse({
