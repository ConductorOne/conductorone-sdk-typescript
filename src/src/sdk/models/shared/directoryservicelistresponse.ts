...
export namespace DirectoryServiceListResponse$ {
    export type Inbound = {
        expanded?: Array<DirectoryServiceListResponseExpanded$.Inbound> | null | undefined;
        list?: Array<DirectoryView$.Inbound> | null | undefined;
        nextPageToken?: string | undefined;
    };

    export const inboundSchema: z.ZodType<DirectoryServiceListResponse, z.ZodTypeDef, Inbound> = z
        .object({
            expanded: z
                .nullable(
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DirectoryServiceListResponse> = z
        .object({
            expanded: z
                .nullable(
