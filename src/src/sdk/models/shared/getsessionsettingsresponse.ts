...
export namespace GetSessionSettingsResponse$ {
    ...
    export const inboundSchema: z.ZodType<GetSessionSettingsResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetSessionSettingsResponse> = z
        .object({
