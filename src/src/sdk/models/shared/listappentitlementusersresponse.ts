...
import { AppEntitlementUserView, AppEntitlementUserView$ } from "./appentitlementuserview";
...
export namespace ListAppEntitlementUsersResponse$ {
    export type Inbound = {
        expanded?: Array<ListAppEntitlementUsersResponseExpanded$.Inbound> | null | undefined;
        list?: Array<AppEntitlementUserView$.Inbound> | null | undefined;
        nextPageToken?: string | undefined;
    };

    export const inboundSchema: z.ZodType<ListAppEntitlementUsersResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
                expanded: z
                    .nullable(
    ...
    > = z
        .object({
            expanded: z
                .nullable(
                    z.array(z.lazy(() => ListAppEntitlementUsersResponseExpanded$.outboundSchema))
                )
                .optional(),
