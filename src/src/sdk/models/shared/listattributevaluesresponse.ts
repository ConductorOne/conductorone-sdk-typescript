...
export namespace ListAttributeValuesResponse$ {
    ...
    export const inboundSchema: z.ZodType<ListAttributeValuesResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListAttributeValuesResponse> = z
        .object({
