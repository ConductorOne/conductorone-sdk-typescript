...
export namespace TaskExpandMask$ {
    ...
    export const inboundSchema: z.ZodType<TaskExpandMask, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TaskExpandMask> = z
        .object({
            paths: z.nullable(z.array(z.string())).optional(),
        })
        .transform((v) => {
