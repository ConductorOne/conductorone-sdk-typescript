...
export namespace C1ApiIamV1RolesListRequest$ {
    ...
    export const inboundSchema: z.ZodType<C1ApiIamV1RolesListRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, C1ApiIamV1RolesListRequest> = z
        .object({
...
export namespace C1ApiIamV1RolesListResponse$ {
    export type Inbound = {
        ContentType: string;
        ListRolesResponse?: shared.ListRolesResponse$.Inbound | undefined;
        StatusCode: number;
        RawResponse: Response;
    };

    export const inboundSchema: z.ZodType<C1ApiIamV1RolesListResponse, z.ZodTypeDef, Inbound> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...
                ...(v.ListRolesResponse === undefined
                    ? null
                    : { listRolesResponse: v.ListRolesResponse }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, C1ApiIamV1RolesListResponse> = z
        .object({
            contentType: z.string(),
