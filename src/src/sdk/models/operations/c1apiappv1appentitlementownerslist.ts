...
export class C1ApiAppV1AppEntitlementOwnersListRequest extends SpeakeasyBase {
...
export class C1ApiAppV1AppEntitlementOwnersListResponse extends SpeakeasyBase {
    /**
