...
export type C1ApiAppV1AppEntitlementsCreateAutomationRequest = {
  ...
  createAutomationRequest?: shared.CreateAutomationRequestInput | undefined;
};
...
export type C1ApiAppV1AppEntitlementsCreateAutomationRequest$Outbound = {
  ...
  CreateAutomationRequest?:
    | shared.CreateAutomationRequestInput$Outbound
    | undefined;
};
...
export const C1ApiAppV1AppEntitlementsCreateAutomationRequest$outboundSchema:
  ...
  > = z.object({
    ...
    createAutomationRequest: shared.CreateAutomationRequestInput$outboundSchema
      .optional(),
  }).transform((v) => {
    return remap$(v, {
      appId: "app_id",
