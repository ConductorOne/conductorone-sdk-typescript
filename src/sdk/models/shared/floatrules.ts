...
/** @internal */
export const FloatRules$inboundSchema: z.ZodType<
  FloatRules,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const FloatRules$outboundSchema: z.ZodType<
  FloatRules$Outbound,
  z.ZodTypeDef,
  FloatRules
> = z.object({
...
export function floatRulesFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => FloatRules$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'FloatRules' from JSON`,
  );
}
