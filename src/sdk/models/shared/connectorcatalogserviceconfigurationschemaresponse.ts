...
export const ConnectorCatalogServiceConfigurationSchemaResponse$inboundSchema:
  z.ZodType<
    ...
    unknown
  > = z.object({
    formSchema: FormInput$inboundSchema.optional(),
...
export type ConnectorCatalogServiceConfigurationSchemaResponse$Outbound = {
  formSchema?: FormInput$Outbound | undefined;
  schema?: ConfigSchema$Outbound | undefined;
};
...
export const ConnectorCatalogServiceConfigurationSchemaResponse$outboundSchema:
  ...
  > = z.object({
    ...
    configSchema: ConfigSchema$outboundSchema.optional(),
  }).transform((v) => {
    return remap$(v, {
      form: "formSchema",
      configSchema: "schema",
