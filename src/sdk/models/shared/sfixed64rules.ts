...
/** @internal */
export const SFixed64Rules$inboundSchema: z.ZodType<
  SFixed64Rules,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const SFixed64Rules$outboundSchema: z.ZodType<
...
export function sFixed64RulesFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => SFixed64Rules$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SFixed64Rules' from JSON`,
  );
}
