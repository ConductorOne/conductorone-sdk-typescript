...
export type TaskSearchRequest = {
  ...
  outcomeAfter?: Date | undefined;
  outcomeBefore?: Date | undefined;
  /**
...
> = z.object({
  ...
  outcomeAfter: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ).optional(),
  outcomeBefore: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ).optional(),
...
export type TaskSearchRequest$Outbound = {
  ...
  openerIds?: Array<string> | null | undefined;
  openerOrSubjectUserId?: string | null | undefined;
  outcomeAfter?: string | undefined;
  outcomeBefore?: string | undefined;
  pageSize?: number | null | undefined;
  pageToken?: string | null | undefined;
  previouslyActedOnIds?: Array<string> | null | undefined;
  query?: string | null | undefined;
...
> = z.object({
  ...
  openerIds: z.nullable(z.array(z.string())).optional(),
  openerOrSubjectUserId: z.nullable(z.string()).optional(),
  outcomeAfter: z.date().transform(v => v.toISOString()).optional(),
  outcomeBefore: z.date().transform(v => v.toISOString()).optional(),
  pageSize: z.nullable(z.number().int()).optional(),
  pageToken: z.nullable(z.string()).optional(),
  previouslyActedOnIds: z.nullable(z.array(z.string())).optional(),
  query: z.nullable(z.string()).optional(),
