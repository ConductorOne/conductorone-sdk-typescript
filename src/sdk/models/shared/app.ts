...
import {
  AppUserMapper,
  AppUserMapper$inboundSchema,
  AppUserMapper$Outbound,
  AppUserMapper$outboundSchema,
} from "./appusermapper.js";
...
export const AccessModel = {
  AppAccessModelUnspecified: "APP_ACCESS_MODEL_UNSPECIFIED",
  AppAccessModelClassic: "APP_ACCESS_MODEL_CLASSIC",
  AppAccessModelHybrid: "APP_ACCESS_MODEL_HYBRID",
  AppAccessModelSparse: "APP_ACCESS_MODEL_SPARSE",
} as const;
/**
 * How this app models access. Derived during uplift from the app's resource type traits.
 *
 ...
 *  Sparse ACL feature.
 */
export type AccessModel = OpenEnum<typeof AccessModel>;
...
export const IdentityMatching = {
  ...
  AppUserIdentityMatchingCustom: "APP_USER_IDENTITY_MATCHING_CUSTOM",
} as const;
/**
 * The identityMatching field.
 */
...
/** @internal */
export const AccessModel$inboundSchema: z.ZodType<
  AccessModel,
  z.ZodTypeDef,
  unknown
> = openEnums.inboundSchema(AccessModel);
/** @internal */
export const AccessModel$outboundSchema: z.ZodType<
  string,
  z.ZodTypeDef,
  AccessModel
> = openEnums.outboundSchema(AccessModel);
