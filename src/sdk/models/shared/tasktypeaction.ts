 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace TaskTypeAction$ {
  /** @deprecated use `TaskTypeAction$inboundSchema` instead. */
  export const inboundSchema = TaskTypeAction$inboundSchema;
  /** @deprecated use `TaskTypeAction$outboundSchema` instead. */
  export const outboundSchema = TaskTypeAction$outboundSchema;
  /** @deprecated use `TaskTypeAction$Outbound` instead. */
  export type Outbound = TaskTypeAction$Outbound;
}
