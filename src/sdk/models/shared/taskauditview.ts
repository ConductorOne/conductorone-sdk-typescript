...
> = z.object({
  ...
  return remap$(v, {
    "accountLifecycleActionCreated": "taskAuditAccountLifecycleActionCreated",
    "accountLifecycleActionFailed": "taskAuditAccountLifecycleActionFailed",
    "provisionCancelled": "taskAuditPolicyProvisionCancelled",
  });
});
...
> = z.object({
  accessRequestOutcome: z.nullable(TaskAuditAccessRequestOutcome$outboundSchema)
    .optional(),
  taskAuditAccountLifecycleActionCreated: z.nullable(
    TaskAuditAccountLifecycleActionCreated$outboundSchema,
  ).optional(),
  taskAuditAccountLifecycleActionFailed: z.nullable(
    TaskAuditAccountLifecycleActionFailed$outboundSchema,
  ).optional(),
  ...
  policyEvaluationStep: z.nullable(TaskAuditPolicyEvaluationStep$outboundSchema)
    .optional(),
  taskAuditPolicyProvisionCancelled: z.nullable(
    TaskAuditPolicyProvisionCancelled$outboundSchema,
  ).optional(),
  ...
  return remap$(v, {
    taskAuditAccountLifecycleActionCreated: "accountLifecycleActionCreated",
    taskAuditAccountLifecycleActionFailed: "accountLifecycleActionFailed",
    taskAuditPolicyProvisionCancelled: "provisionCancelled",
  });
});
