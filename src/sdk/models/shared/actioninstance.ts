...
export const ActionInstance$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: z.nullable(Action1$inboundSchema).optional(),
...
export type ActionInstance$Outbound = {
  action?: Action1$Outbound | null | undefined;
...
export const ActionInstance$outboundSchema: z.ZodType<
  ...
  ActionInstance
> = z.object({
  action: z.nullable(Action1$outboundSchema).optional(),
