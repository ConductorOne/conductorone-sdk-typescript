...
> = z
  .union([
    z.nativeEnum(ActionInstanceState),
 ...
 */
export namespace ActionInstanceState$ {
  /** @deprecated use `ActionInstanceState$inboundSchema` instead. */
  export const inboundSchema = ActionInstanceState$inboundSchema;
  /** @deprecated use `ActionInstanceState$outboundSchema` instead. */
  export const outboundSchema = ActionInstanceState$outboundSchema;
}
...
export namespace ActionInstance$ {
  /** @deprecated use `ActionInstance$inboundSchema` instead. */
  export const inboundSchema = ActionInstance$inboundSchema;
  /** @deprecated use `ActionInstance$outboundSchema` instead. */
  export const outboundSchema = ActionInstance$outboundSchema;
  /** @deprecated use `ActionInstance$Outbound` instead. */
  export type Outbound = ActionInstance$Outbound;
}
