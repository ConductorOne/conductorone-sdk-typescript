...
export type AutomationTrigger = {
   ...
   *   - allConflictMonitors
   */
  accessConflictTrigger?: AccessConflictTrigger | null | undefined;
...
> = z.object({
  ...
  return remap$(v, {
    "accessConflict": "accessConflictTrigger",
  });
});
...
export const AutomationTrigger$outboundSchema: z.ZodType<
  ...
  AutomationTrigger
> = z.object({
  accessConflictTrigger: z.nullable(AccessConflictTrigger$outboundSchema)
    .optional(),
  ...
  return remap$(v, {
    accessConflictTrigger: "accessConflict",
  });
});
