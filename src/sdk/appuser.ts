...
export class AppUser {
    ...
    async update(
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.C1ApiAppV1AppUserServiceUpdateRequest(req);
        }
        ...
        const res: operations.C1ApiAppV1AppUserServiceUpdateResponse =
            new operations.C1ApiAppV1AppUserServiceUpdateResponse({
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.appUserServiceUpdateResponse = utils.objectToClass(
