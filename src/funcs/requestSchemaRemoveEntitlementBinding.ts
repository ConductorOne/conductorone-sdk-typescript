...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.RequestSchemaServiceRemoveEntitlementBindingRequest$outboundSchema
  ...
  const context = {
    ...
    operationID:
      "c1.api.request_schema.v1.RequestSchemaService.RemoveEntitlementBinding",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "RequestSchemaServiceRemoveEntitlementBindingResponse" },
    ),
