...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.VaultServiceCreateRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/vaults")();
  ...
  >(
    M.json(
      200,
      operations.C1ApiVaultV1VaultServiceCreateResponse$inboundSchema,
      { key: "VaultServiceCreateResponse" },
    ),
