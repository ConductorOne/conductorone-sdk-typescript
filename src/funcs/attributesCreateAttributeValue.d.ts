 ...
 */
export declare function attributesCreateAttributeValue(client: ConductoroneSDKTypescriptCore, request?: shared.CreateAttributeValueRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAttributeV1AttributesCreateAttributeValueResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
