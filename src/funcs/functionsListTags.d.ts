 ...
 */
export declare function functionsListTags(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiFunctionsV1FunctionsServiceListTagsRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiFunctionsV1FunctionsServiceListTagsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
