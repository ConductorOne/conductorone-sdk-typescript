 ...
 */
export declare function personalClientList(client: ConductoroneSDKTypescriptCore, options?: RequestOptions): APIPromise<Result<operations.C1ApiIamV1PersonalClientServiceListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
