 ...
 */
export async function appResourceTypeCreateManuallyManagedResourceType(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.CreateManuallyManagedResourceTypeRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      ...
      { key: "CreateManuallyManagedResourceTypeResponse" },
    ),
