 ...
 */
export declare function taskActionsApprove(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiTaskV1TaskActionsServiceApproveRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskActionsServiceApproveResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
