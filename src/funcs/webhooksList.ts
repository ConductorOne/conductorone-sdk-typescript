...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.C1ApiWebhooksV1WebhooksServiceListRequest$outboundSchema.parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.C1ApiWebhooksV1WebhooksServiceListResponse$inboundSchema,
      { key: "WebhooksServiceListResponse" },
    ),
