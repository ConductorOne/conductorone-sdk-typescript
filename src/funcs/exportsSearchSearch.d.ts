 ...
 */
export declare function exportsSearchSearch(client: ConductoroneSDKTypescriptCore, request?: shared.ExportsSearchServiceSearchRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiSystemlogV1ExportsSearchServiceSearchResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
