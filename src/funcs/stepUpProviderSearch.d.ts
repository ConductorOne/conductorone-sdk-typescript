 ...
 */
export declare function stepUpProviderSearch(client: ConductoroneSDKTypescriptCore, request?: shared.SearchStepUpProvidersRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiStepupV1StepUpProviderServiceSearchResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
