...
export function hooksCreate(
  ...
  Result<
    operations.C1ApiHooksV1HooksServiceCreateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.HooksServiceCreateRequest$outboundSchema.optional().parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiHooksV1HooksServiceCreateResponse$inboundSchema,
      { key: "HooksServiceCreateResponse" },
    ),
