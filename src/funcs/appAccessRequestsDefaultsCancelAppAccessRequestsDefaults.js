 ...
 */
export function appAccessRequestsDefaultsCancelAppAccessRequestsDefaults(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/api/v1/apps/{app_id}/access_request_defaults/cancel")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppAccessRequestsDefaultsServiceCancelAppAccessRequestsDefaultsResponse$inboundSchema, { key: "AppAccessRequestDefaults" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
