 ...
 * Create a grant task
 */
export declare function taskCreateGrantTask(client: ConductoroneSDKTypescriptCore, request?: shared.TaskServiceCreateGrantRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskServiceCreateGrantTaskResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
