...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiWebhooksV1WebhooksServiceTestRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiWebhooksV1WebhooksServiceTestResponse$inboundSchema,
      { key: "WebhooksServiceTestResponse" },
    ),
