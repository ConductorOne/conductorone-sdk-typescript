 ...
 */
export declare function appEntitlementUserBindingUpdateGrantDuration(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppEntitlementUserBindingServiceUpdateGrantDurationRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppEntitlementUserBindingServiceUpdateGrantDurationResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
