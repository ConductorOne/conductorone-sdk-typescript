 ...
 */
export function attributesGetAttributeValue(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/api/v1/attributes/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAttributeV1AttributesGetAttributeValueResponse$inboundSchema, { key: "GetAttributeValueResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
