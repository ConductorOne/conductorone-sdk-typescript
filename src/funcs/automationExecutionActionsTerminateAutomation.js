 ...
 */
export function automationExecutionActionsTerminateAutomation(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/api/v1/automation_executions/{id}/actions/terminate")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAutomationsV1AutomationExecutionActionsServiceTerminateAutomationResponse$inboundSchema, { key: "TerminateAutomationResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
