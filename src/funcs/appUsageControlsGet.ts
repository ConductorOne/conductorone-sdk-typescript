 ...
 */
export async function appUsageControlsGet(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1AppUsageControlsServiceGetRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppUsageControlsServiceGetResponse$inboundSchema,
      { key: "GetAppUsageControlsResponse" },
    ),
