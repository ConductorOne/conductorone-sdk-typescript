 ...
 */
export function principalAddBinding(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.ServicePrincipalServiceAddBindingRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/service_principals/bindings")();
  ...
  const context = {
    ...
    operationID:
      "c1.api.service_principal.v1.ServicePrincipalService.AddBinding",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "ServicePrincipalServiceAddBindingResponse" },
    ),
