 ...
 */
export declare function stepUpProviderDelete(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiStepupV1StepUpProviderServiceDeleteRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiStepupV1StepUpProviderServiceDeleteResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
