 ...
 */
export declare function appOwnersRemove(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppOwnersRemoveRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppOwnersRemoveResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
