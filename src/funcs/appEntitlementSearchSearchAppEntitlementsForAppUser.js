 ...
 */
export function appEntitlementSearchSearchAppEntitlementsForAppUser(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/api/v1/search/apps/{app_id}/entitlements/users/{app_user_id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppEntitlementSearchServiceSearchAppEntitlementsForAppUserResponse$inboundSchema, { key: "ListAppEntitlementsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
