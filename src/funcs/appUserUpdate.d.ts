 ...
 */
export declare function appUserUpdate(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppUserServiceUpdateRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppUserServiceUpdateResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
