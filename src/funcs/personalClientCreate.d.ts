 ...
 */
export declare function personalClientCreate(client: ConductoroneSDKTypescriptCore, request?: shared.PersonalClientServiceCreateRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiIamV1PersonalClientServiceCreateResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
