 ...
 */
export function roleMiningManagementListCustomAnalysisResults(
...
> {
  const path = pathToFunc("/api/v1/role-mining/custom-analysis")();
  ...
  >(
    M.json(
      ...
      { key: "ListCustomAnalysisResultsResponse" },
    ),
