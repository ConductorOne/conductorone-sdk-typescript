 ...
 */
export declare function directoryDelete(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiDirectoryV1DirectoryServiceDeleteRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiDirectoryV1DirectoryServiceDeleteResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
