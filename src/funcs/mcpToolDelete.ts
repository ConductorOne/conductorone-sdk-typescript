...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAiGovernanceV1MCPToolServiceDeleteRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.MCPToolServiceDeleteRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiAiGovernanceV1MCPToolServiceDeleteResponse$inboundSchema,
      { key: "MCPToolServiceDeleteResponse" },
    ),
