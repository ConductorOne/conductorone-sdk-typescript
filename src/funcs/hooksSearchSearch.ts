...
> {
  const parsed = safeParse(
    request,
    (value) => shared.HooksSearchRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/search/hooks")();
  ...
  >(
    M.json(
      200,
      operations.C1ApiHooksV1HooksSearchSearchResponse$inboundSchema,
      { key: "HooksSearchResponse" },
    ),
