...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.DirectoryServiceCreateRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiDirectoryV1DirectoryServiceCreateResponse$inboundSchema,
      { key: "DirectoryServiceCreateResponse" },
    ),
