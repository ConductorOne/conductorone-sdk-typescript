 ...
 */
export function stepUpProviderGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiStepupV1StepUpProviderServiceGetRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiStepupV1StepUpProviderServiceGetResponse$inboundSchema,
      { key: "GetStepUpProviderResponse" },
    ),
