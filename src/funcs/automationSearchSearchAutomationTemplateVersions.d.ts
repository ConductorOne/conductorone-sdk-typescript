 ...
 */
export declare function automationSearchSearchAutomationTemplateVersions(client: ConductoroneSDKTypescriptCore, request?: shared.SearchAutomationTemplateVersionsRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAutomationsV1AutomationSearchServiceSearchAutomationTemplateVersionsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
