 ...
 */
export async function appEntitlementUserBindingListAppUsersForIdentityWithGrant(
...
> {
  ...
  const pathParams = {
    ...
    identity_user_id: encodeSimple(
      "identity_user_id",
      payload.identity_user_id,
      { explode: false, charEncoding: "percent" },
    ),
  };
  ...
  >(
    M.json(
      ...
      { key: "ListAppUsersForIdentityWithGrantResponse" },
    ),
