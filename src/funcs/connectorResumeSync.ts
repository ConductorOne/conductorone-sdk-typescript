...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1ConnectorServiceResumeSyncRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1ConnectorServiceResumeSyncResponse$inboundSchema,
      { key: "ResumeSyncResponse" },
    ),
