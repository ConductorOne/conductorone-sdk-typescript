 ...
 */
export declare function accessConflictUpdateMonitor(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAccessconflictV1AccessConflictServiceUpdateMonitorRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAccessconflictV1AccessConflictServiceUpdateMonitorResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
