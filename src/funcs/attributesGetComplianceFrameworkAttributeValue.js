 ...
 */
export function attributesGetComplianceFrameworkAttributeValue(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAttributeV1AttributesGetComplianceFrameworkAttributeValueResponse$inboundSchema, { key: "GetComplianceFrameworkAttributeValueResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
