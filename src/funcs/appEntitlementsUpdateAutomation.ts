 ...
 */
export function appEntitlementsUpdateAutomation(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppEntitlementsUpdateAutomationRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.AppEntitlementServiceUpdateAutomationRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      ...
      { key: "AppEntitlementServiceUpdateAutomationResponse" },
    ),
