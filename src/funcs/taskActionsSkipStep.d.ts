 ...
 */
export declare function taskActionsSkipStep(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiTaskV1TaskActionsServiceSkipStepRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskActionsServiceSkipStepResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
