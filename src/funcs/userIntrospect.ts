...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.UserIntrospectRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/users/introspect")();
  ...
  const context = {
    ...
    operationID: "c1.api.user.v1.UserService.Introspect",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.C1ApiUserV1UserServiceIntrospectResponse$inboundSchema,
      { key: "UserIntrospectResponse" },
    ),
