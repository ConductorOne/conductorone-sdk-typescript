 ...
 */
export declare function webhooksSearchSearch(client: ConductoroneSDKTypescriptCore, request?: shared.WebhooksSearchRequest | undefined, options?: RequestOptions): APIPromise<PageIterator<Result<operations.C1ApiWebhooksV1WebhooksSearchSearchResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>, {
    cursor: string;
}>>;
