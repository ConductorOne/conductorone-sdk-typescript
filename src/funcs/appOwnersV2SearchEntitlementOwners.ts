 ...
 */
export function appOwnersV2SearchEntitlementOwners(
  client: ConductoroneSDKTypescriptCore,
  request: operations.C1ApiAppV2AppOwnersSearchEntitlementOwnersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiAppV2AppOwnersSearchEntitlementOwnersResponse,
...
> {
  ...
  const path = pathToFunc("/api/v2/apps/{app_id}/owners/entitlements")(
    pathParams,
  );
