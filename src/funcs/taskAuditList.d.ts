 ...
 */
export declare function taskAuditList(client: ConductoroneSDKTypescriptCore, request?: shared.TaskAuditListRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskAuditListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
