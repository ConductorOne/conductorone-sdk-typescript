 ...
 */
export declare function attributesCreateComplianceFrameworkAttributeValue(client: ConductoroneSDKTypescriptCore, request?: shared.CreateComplianceFrameworkAttributeValueRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAttributeV1AttributesCreateComplianceFrameworkAttributeValueResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
