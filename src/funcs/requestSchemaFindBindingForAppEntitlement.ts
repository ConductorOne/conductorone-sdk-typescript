 ...
 */
export function requestSchemaFindBindingForAppEntitlement(
...
> {
  ...
  const context = {
    ...
    operationID:
      "c1.api.request_schema.v1.RequestSchemaService.FindBindingForAppEntitlement",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "RequestSchemaServiceFindBindingForAppEntitlementResponse" },
    ),
