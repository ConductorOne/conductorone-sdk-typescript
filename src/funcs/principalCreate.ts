...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.ServicePrincipalServiceCreateRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/service_principals")();
  ...
  >(
    M.json(
      ...
      { key: "ServicePrincipalServiceCreateResponse" },
    ),
