 ...
 */
export declare function appUserSearch(client: ConductoroneSDKTypescriptCore, request?: shared.AppUserServiceSearchRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppUserServiceSearchResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
