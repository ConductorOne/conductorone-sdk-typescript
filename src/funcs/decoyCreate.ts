...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.DecoyServiceCreateRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/decoys")();
  ...
  >(
    M.json(
      200,
      operations.C1ApiDecoyV1DecoyServiceCreateResponse$inboundSchema,
      { key: "DecoyServiceCreateResponse" },
    ),
