...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiVaultV1VaultServiceGetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.C1ApiVaultV1VaultServiceGetResponse$inboundSchema, {
      key: "VaultServiceGetResponse",
    }),
