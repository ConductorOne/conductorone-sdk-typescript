 ...
 */
export function requestSchemaCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.RequestSchemaServiceCreateRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/request_schemas")();
  ...
  >(
    M.json(
      ...
      { key: "RequestSchemaServiceCreateResponse" },
    ),
