 ...
 */
export function appResourceTypeCreateManuallyManagedResourceType(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.CreateManuallyManagedResourceTypeRequest, { explode: true });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppResourceTypeServiceCreateManuallyManagedResourceTypeResponse$inboundSchema, { key: "CreateManuallyManagedResourceTypeResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
