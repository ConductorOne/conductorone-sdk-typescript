 ...
 */
export function automationExecutionGetAutomationExecution(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAutomationsV1AutomationExecutionServiceGetAutomationExecutionResponse$inboundSchema, { key: "GetAutomationExecutionResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
