 ...
 */
export function requestCatalogManagementAddAccessEntitlements(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.RequestCatalogManagementServiceAddAccessEntitlementsRequest, { explode: true });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/catalogs/{catalog_id}/visibility_bindings")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiRequestcatalogV1RequestCatalogManagementServiceAddAccessEntitlementsResponse$inboundSchema, { key: "RequestCatalogManagementServiceAddAccessEntitlementsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
