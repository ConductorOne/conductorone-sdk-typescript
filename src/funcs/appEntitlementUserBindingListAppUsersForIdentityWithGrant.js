 ...
 */
export function appEntitlementUserBindingListAppUsersForIdentityWithGrant(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const pathParams = {
        ...
        identity_user_id: encodeSimple("identity_user_id", payload.identity_user_id, { explode: false, charEncoding: "percent" }),
    };
    const path = pathToFunc("/api/v1/apps/{app_id}/entitlements/{app_entitlement_id}/users/{identity_user_id}/grants")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppEntitlementUserBindingServiceListAppUsersForIdentityWithGrantResponse$inboundSchema, { key: "ListAppUsersForIdentityWithGrantResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
