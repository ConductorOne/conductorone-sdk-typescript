 ...
 */
export function requestCatalogManagementDeleteBundleAutomation(
...
> {
  ...
  const context = {
    ...
    operationID:
      "c1.api.requestcatalog.v1.RequestCatalogManagementService.DeleteBundleAutomation",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "DeleteBundleAutomationResponse" },
    ),
