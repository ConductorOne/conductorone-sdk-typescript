 ...
 * Get a user by ID.
 */
export declare function userGet(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiUserV1UserServiceGetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiUserV1UserServiceGetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
