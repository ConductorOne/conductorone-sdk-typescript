 ...
 */
export declare function functionsGetCommit(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiFunctionsV1FunctionsServiceGetCommitRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiFunctionsV1FunctionsServiceGetCommitResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
