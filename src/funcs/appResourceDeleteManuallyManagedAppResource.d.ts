 ...
 */
export declare function appResourceDeleteManuallyManagedAppResource(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppResourceServiceDeleteManuallyManagedAppResourceRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppResourceServiceDeleteManuallyManagedAppResourceResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
