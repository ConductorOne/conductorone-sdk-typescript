 ...
 */
export function automationGetAutomation(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAutomationsV1AutomationServiceGetAutomationResponse$inboundSchema, { key: "GetAutomationResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
