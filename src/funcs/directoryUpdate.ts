...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiDirectoryV1DirectoryServiceUpdateRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.DirectoryServiceUpdateRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiDirectoryV1DirectoryServiceUpdateResponse$inboundSchema,
      { key: "DirectoryServiceUpdateResponse" },
    ),
