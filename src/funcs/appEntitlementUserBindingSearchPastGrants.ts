...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchPastGrantsRequest$outboundSchema.optional().parse(value),
  ...
  const context = {
    ...
    operationID:
      "c1.api.app.v1.AppEntitlementUserBindingService.SearchPastGrants",
    oAuth2Scopes: [],
