 ...
 */
export function taskActionsProcessNow(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiTaskV1TaskActionsServiceProcessNowRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiTaskV1TaskActionsServiceProcessNowResponse$inboundSchema,
      { key: "TaskActionsServiceProcessNowResponse" },
    ),
