...
export function mcpToolSearch(
  ...
  Result<
    operations.C1ApiAiGovernanceV1MCPToolServiceSearchResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAiGovernanceV1MCPToolServiceSearchRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.MCPToolServiceSearchRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiAiGovernanceV1MCPToolServiceSearchResponse$inboundSchema,
      { key: "MCPToolServiceSearchResponse" },
    ),
