 ...
 */
export function stepUpProviderSearch(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchStepUpProvidersRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiStepupV1StepUpProviderServiceSearchResponse$inboundSchema,
      { key: "SearchStepUpProvidersResponse" },
    ),
