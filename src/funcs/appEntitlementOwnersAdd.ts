 ...
 */
export async function appEntitlementOwnersAdd(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1AppEntitlementOwnersAddRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppEntitlementOwnersAddResponse$inboundSchema,
      { key: "AddAppEntitlementOwnerResponse" },
    ),
