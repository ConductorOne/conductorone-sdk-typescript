...
export function decoyRotate(
  ...
  Result<
    operations.C1ApiDecoyV1DecoyServiceRotateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiDecoyV1DecoyServiceRotateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.DecoyServiceRotateRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v1/decoys/{id}/rotate")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.C1ApiDecoyV1DecoyServiceRotateResponse$inboundSchema,
