 ...
 */
export function appEntitlementsAddManuallyManagedMembers(
  client: ConductoroneSDKTypescriptCore,
  request: operations.C1ApiAppV1AppEntitlementsAddManuallyManagedMembersRequest,
...
> {
  ...
  >(
    M.json(
      ...
      { key: "ManuallyManagedUsersResponse" },
    ),
