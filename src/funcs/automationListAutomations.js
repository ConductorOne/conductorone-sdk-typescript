 ...
 */
export function automationListAutomations(client, options) {
...
async function $do(client, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAutomationsV1AutomationServiceListAutomationsResponse$inboundSchema, { key: "ListAutomationsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
