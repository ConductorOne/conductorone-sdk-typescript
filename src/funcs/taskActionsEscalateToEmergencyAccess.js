 ...
 */
export function taskActionsEscalateToEmergencyAccess(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.TaskActionsServiceEscalateToEmergencyAccessRequest, { explode: true });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/tasks/{task_id}/action/escalate")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiTaskV1TaskActionsServiceEscalateToEmergencyAccessResponse$inboundSchema, { key: "TaskServiceActionResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
