 ...
 * List directories.
 */
export declare function directoryList(client: ConductoroneSDKTypescriptCore, request?: operations.C1ApiDirectoryV1DirectoryServiceListRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiDirectoryV1DirectoryServiceListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
