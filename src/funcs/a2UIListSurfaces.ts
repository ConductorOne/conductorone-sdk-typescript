...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiA2uiV1A2UIServiceListSurfacesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiA2uiV1A2UIServiceListSurfacesResponse$inboundSchema,
      { key: "A2UIServiceListSurfacesResponse" },
    ),
