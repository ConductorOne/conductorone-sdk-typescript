 ...
 */
export function appUserListAppUsersForUser(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/api/v1/apps/{app_id}/users/{user_id}/app_users")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppUserServiceListAppUsersForUserResponse$inboundSchema, { key: "AppUsersForUserServiceListResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
