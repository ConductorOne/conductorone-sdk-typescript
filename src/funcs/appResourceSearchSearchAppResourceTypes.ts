 ...
 */
export function appResourceSearchSearchAppResourceTypes(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchAppResourceTypesRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  >(
    M.json(
      ...
      { key: "SearchAppResourceTypesResponse" },
    ),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      appResourceSearchSearchAppResourceTypes(
        client,
        {
          ...request,
