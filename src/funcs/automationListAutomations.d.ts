 ...
 */
export declare function automationListAutomations(client: ConductoroneSDKTypescriptCore, options?: RequestOptions): APIPromise<Result<operations.C1ApiAutomationsV1AutomationServiceListAutomationsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
