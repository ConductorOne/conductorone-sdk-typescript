 ...
 */
export declare function appEntitlementMonitorBindingGetAppEntitlementMonitorBinding(client: ConductoroneSDKTypescriptCore, request?: shared.GetAppEntitlementMonitorBindingRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAccessconflictV1AppEntitlementMonitorBindingServiceGetAppEntitlementMonitorBindingResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
