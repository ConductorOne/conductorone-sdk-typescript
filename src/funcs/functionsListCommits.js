 ...
 */
export function functionsListCommits(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiFunctionsV1FunctionsServiceListCommitsResponse$inboundSchema, { key: "FunctionsServiceListCommitsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
