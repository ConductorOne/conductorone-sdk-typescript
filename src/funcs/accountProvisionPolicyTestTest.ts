 ...
 */
export function accountProvisionPolicyTestTest(
  client: ConductoroneSDKTypescriptCore,
  request?: shared.TestAccountProvisionPolicyRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiPolicyV1AccountProvisionPolicyTestTestResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.TestAccountProvisionPolicyRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  >(
    M.json(
      ...
      { key: "TestAccountProvisionPolicyResponse" },
    ),
