 ...
 */
export async function connectorGetCredentials(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1ConnectorServiceGetCredentialsRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1ConnectorServiceGetCredentialsResponse$inboundSchema,
      { key: "ConnectorServiceGetCredentialsResponse" },
    ),
