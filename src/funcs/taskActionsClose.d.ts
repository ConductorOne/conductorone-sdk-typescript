 ...
 */
export declare function taskActionsClose(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiTaskV1TaskActionsServiceCloseRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskActionsServiceCloseResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
