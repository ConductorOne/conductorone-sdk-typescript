 ...
 */
export function appResourceOwnersV2SearchEntitlementOwners(
...
> {
  ...
  const path = pathToFunc(
    "/api/v2/apps/{app_id}/resource_types/{resource_type_id}/resources/{resource_id}/owners/entitlements",
  )(pathParams);
  ...
  >(
    M.json(
      ...
      { key: "SearchAppResourceEntitlementOwnersResponse" },
    ),
