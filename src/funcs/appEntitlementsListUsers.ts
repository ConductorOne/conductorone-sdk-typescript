 ...
 */
export async function appEntitlementsListUsers(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1AppEntitlementsListUsersRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppEntitlementsListUsersResponse$inboundSchema,
      { key: "ListAppEntitlementUsersResponse" },
    ),
