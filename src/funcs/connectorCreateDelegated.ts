 ...
 */
export async function connectorCreateDelegated(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1ConnectorServiceCreateDelegatedRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.ConnectorServiceCreateDelegatedRequest,
    { explode: true },
  );
