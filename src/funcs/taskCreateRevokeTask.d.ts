 ...
 */
export declare function taskCreateRevokeTask(client: ConductoroneSDKTypescriptCore, request?: shared.TaskServiceCreateRevokeRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskServiceCreateRevokeTaskResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
