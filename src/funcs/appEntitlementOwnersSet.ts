 ...
 */
export async function appEntitlementOwnersSet(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.C1ApiAppV1AppEntitlementOwnersSetRequest$outboundSchema.parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.C1ApiAppV1AppEntitlementOwnersSetResponse$inboundSchema,
      { key: "SetAppEntitlementOwnersResponse" },
    ),
