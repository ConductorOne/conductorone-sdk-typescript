 ...
 */
export declare function appResourceGet(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppResourceServiceGetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppResourceServiceGetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
