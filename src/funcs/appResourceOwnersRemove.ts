 ...
 */
export function appResourceOwnersRemove(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppResourceOwnersRemoveRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceOwnersRemoveResponse$inboundSchema,
      { key: "RemoveAppResourceOwnerResponse" },
    ),
