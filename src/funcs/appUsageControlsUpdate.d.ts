 ...
 */
export declare function appUsageControlsUpdate(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppUsageControlsServiceUpdateRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppUsageControlsServiceUpdateResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
