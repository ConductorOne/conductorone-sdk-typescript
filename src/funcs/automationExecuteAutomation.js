 ...
 */
export function automationExecuteAutomation(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.ExecuteAutomationRequest, {
        explode: true,
    });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/automations/{id}/execute")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAutomationsV1AutomationServiceExecuteAutomationResponse$inboundSchema, { key: "ExecuteAutomationResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
