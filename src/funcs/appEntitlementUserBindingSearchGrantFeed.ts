 ...
 */
export function appEntitlementUserBindingSearchGrantFeed(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchGrantFeedRequest$outboundSchema.optional().parse(value),
  ...
  const context = {
    ...
    operationID:
      "c1.api.app.v1.AppEntitlementUserBindingService.SearchGrantFeed",
    oAuth2Scopes: null,
