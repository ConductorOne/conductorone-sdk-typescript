 ...
 */
export function ssfReceiverStreamCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SSFReceiverStreamServiceCreateRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/ssf-receiver-streams")();
  ...
  >(
    M.json(
      ...
      { key: "SSFReceiverStreamServiceCreateResponse" },
    ),
