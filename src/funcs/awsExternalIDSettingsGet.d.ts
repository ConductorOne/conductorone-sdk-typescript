 ...
 */
export declare function awsExternalIDSettingsGet(client: ConductoroneSDKTypescriptCore, options?: RequestOptions): APIPromise<Result<operations.C1ApiSettingsV1AWSExternalIDSettingsGetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
