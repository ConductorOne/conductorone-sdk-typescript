 ...
 */
export declare function appEntitlementOwnersAdd(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppEntitlementOwnersAddRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppEntitlementOwnersAddResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
