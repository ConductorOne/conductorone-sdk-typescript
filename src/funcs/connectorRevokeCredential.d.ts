 ...
 */
export declare function connectorRevokeCredential(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1ConnectorServiceRevokeCredentialRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1ConnectorServiceRevokeCredentialResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
