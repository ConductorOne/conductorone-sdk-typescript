 ...
 */
export declare function appResourceTypeUpdateManuallyManagedResourceType(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppResourceTypeServiceUpdateManuallyManagedResourceTypeRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppResourceTypeServiceUpdateManuallyManagedResourceTypeResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
