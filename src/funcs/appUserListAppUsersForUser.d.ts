 ...
 */
export declare function appUserListAppUsersForUser(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppUserServiceListAppUsersForUserRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppUserServiceListAppUsersForUserResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
