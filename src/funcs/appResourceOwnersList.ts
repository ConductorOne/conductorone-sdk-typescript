 ...
 */
export async function appResourceOwnersList(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1AppResourceOwnersListRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceOwnersListResponse$inboundSchema,
      { key: "ListAppResourceOwnersResponse" },
    ),
