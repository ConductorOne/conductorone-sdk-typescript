 ...
 */
export function contactsGetContacts(
  client: ConductoroneSDKTypescriptCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiSettingsV1ContactsServiceGetContactsResponse,
...
> {
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiSettingsV1ContactsServiceGetContactsResponse$inboundSchema,
      { key: "GetContactsResponse" },
    ),
