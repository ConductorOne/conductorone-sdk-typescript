 ...
 */
export function appResourceOwnersSet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppResourceOwnersSetRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.SetAppResourceOwnersRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceOwnersSetResponse$inboundSchema,
      { key: "SetAppResourceOwnersResponse" },
    ),
