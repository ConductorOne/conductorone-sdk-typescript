 ...
 */
export function automationUpdateAutomation(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.UpdateAutomationRequest, {
        explode: true,
    });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAutomationsV1AutomationServiceUpdateAutomationResponse$inboundSchema, { key: "UpdateAutomationResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
