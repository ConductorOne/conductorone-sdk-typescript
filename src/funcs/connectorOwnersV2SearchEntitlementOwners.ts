 ...
 */
export function connectorOwnersV2SearchEntitlementOwners(
...
> {
  ...
  const path = pathToFunc(
    "/api/v2/apps/{app_id}/connectors/{connector_id}/owners/entitlements",
  )(pathParams);
  ...
  >(
    M.json(
      ...
      { key: "SearchConnectorEntitlementOwnersResponse" },
    ),
