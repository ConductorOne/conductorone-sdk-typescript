 ...
 */
export function attributesDeleteComplianceFrameworkAttributeValue(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.DeleteComplianceFrameworkAttributeValueRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      ...
      { key: "DeleteComplianceFrameworkAttributeValueResponse" },
    ),
