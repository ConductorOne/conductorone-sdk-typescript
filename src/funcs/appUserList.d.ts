 ...
 */
export declare function appUserList(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppUserServiceListRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppUserServiceListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
