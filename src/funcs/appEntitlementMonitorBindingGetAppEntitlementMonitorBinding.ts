 ...
 */
export function appEntitlementMonitorBindingGetAppEntitlementMonitorBinding(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.GetAppEntitlementMonitorBindingRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/appentitlementmonitorbinding/get")();
  ...
  >(
    M.json(
      ...
      { key: "AppEntitlementMonitorBinding" },
    ),
