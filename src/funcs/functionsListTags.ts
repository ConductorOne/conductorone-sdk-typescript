 ...
 */
export function functionsListTags(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiFunctionsV1FunctionsServiceListTagsRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiFunctionsV1FunctionsServiceListTagsResponse$inboundSchema,
      { key: "FunctionsServiceListTagsResponse" },
    ),
