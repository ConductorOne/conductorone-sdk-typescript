 ...
 */
export function attributesCreateComplianceFrameworkAttributeValue(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.CreateComplianceFrameworkAttributeValueRequest$outboundSchema
  ...
  const context = {
    ...
    operationID:
      "c1.api.attribute.v1.Attributes.CreateComplianceFrameworkAttributeValue",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "CreateComplianceFrameworkAttributeValueResponse" },
    ),
