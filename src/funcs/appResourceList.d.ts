 ...
 */
export declare function appResourceList(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppResourceServiceListRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppResourceServiceListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
