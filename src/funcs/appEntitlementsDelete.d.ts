 ...
 */
export declare function appEntitlementsDelete(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppEntitlementsDeleteRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppEntitlementsDeleteResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
