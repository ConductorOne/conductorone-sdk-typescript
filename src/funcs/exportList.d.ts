 ...
 * List Exports.
 */
export declare function exportList(client: ConductoroneSDKTypescriptCore, request?: operations.C1ApiSystemlogV1ExportServiceListRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiSystemlogV1ExportServiceListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
