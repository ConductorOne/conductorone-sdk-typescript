 ...
 */
export function automationExecutionActionsTerminateAutomation(
...
> {
  ...
  const body = encodeJSON("body", payload.TerminateAutomationRequest, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID:
      "c1.api.automations.v1.AutomationExecutionActionsService.TerminateAutomation",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "TerminateAutomationResponse" },
    ),
