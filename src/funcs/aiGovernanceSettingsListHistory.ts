 ...
 */
export function aiGovernanceSettingsListHistory(
...
> {
  const path = pathToFunc("/api/v1/settings/ai-governance/history")();
  ...
  const context = {
    ...
    operationID:
      "c1.api.ai_governance.v1.AIGovernanceSettingsService.ListHistory",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "ListAIGovernanceSettingsHistoryResponse" },
    ),
