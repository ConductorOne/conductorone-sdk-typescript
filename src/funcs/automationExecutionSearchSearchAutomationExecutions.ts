...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchAutomationExecutionsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID:
      "c1.api.automations.v1.AutomationExecutionSearchService.SearchAutomationExecutions",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "SearchAutomationExecutionsResponse" },
    ),
