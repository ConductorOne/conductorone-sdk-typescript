 ...
 */
export async function exportsSearchSearch(
  client$: ConductoroneSDKTypescriptCore,
  request?: shared.ExportsSearchServiceSearchRequest | undefined,
  options?: RequestOptions,
): Promise<
  Result<
    operations.C1ApiSystemlogV1ExportsSearchServiceSearchResponse,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      shared.ExportsSearchServiceSearchRequest$outboundSchema.optional().parse(
        value$,
      ),
  ...
  >(
    m$.json(
      ...
      { key: "ExportsSearchServiceSearchResponse" },
    ),
