...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAiGovernanceV1MCPToolServiceGetRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAiGovernanceV1MCPToolServiceGetResponse$inboundSchema,
      { key: "MCPToolServiceGetResponse" },
    ),
