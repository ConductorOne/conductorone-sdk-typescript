 ...
 */
export function stepUpProviderDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiStepupV1StepUpProviderServiceDeleteRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiStepupV1StepUpProviderServiceDeleteResponse$inboundSchema,
      { key: "DeleteStepUpProviderResponse" },
    ),
