...
export function hooksUpdate(
  ...
  Result<
    operations.C1ApiHooksV1HooksServiceUpdateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiHooksV1HooksServiceUpdateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.HooksServiceUpdateRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiHooksV1HooksServiceUpdateResponse$inboundSchema,
      { key: "HooksServiceUpdateResponse" },
    ),
