...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .C1ApiFunctionsV1FunctionsServiceGetLockFileRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiFunctionsV1FunctionsServiceGetLockFileResponse$inboundSchema,
      { key: "FunctionsServiceGetLockFileResponse" },
    ),
