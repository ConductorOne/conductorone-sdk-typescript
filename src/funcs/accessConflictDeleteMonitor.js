 ...
 */
export function accessConflictDeleteMonitor(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.ConflictMonitorDeleteRequest, {
        explode: true,
    });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAccessconflictV1AccessConflictServiceDeleteMonitorResponse$inboundSchema, { key: "ConflictMonitorDeleteResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
