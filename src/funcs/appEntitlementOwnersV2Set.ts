...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV2AppEntitlementOwnersSetRequest$outboundSchema.parse(
        value,
      ),
