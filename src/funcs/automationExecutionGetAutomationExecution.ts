 ...
 */
export function automationExecutionGetAutomationExecution(
...
> {
  ...
  const path = pathToFunc("/api/v1/automation_executions/{id}")(pathParams);
  ...
  const context = {
    ...
    operationID:
      "c1.api.automations.v1.AutomationExecutionService.GetAutomationExecution",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "GetAutomationExecutionResponse" },
    ),
