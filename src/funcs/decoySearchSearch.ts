 ...
 *  and annotation key.
 */
export function decoySearchSearch(
  client: ConductoroneSDKTypescriptCore,
  request?: shared.DecoySearchRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiDecoyV1DecoySearchServiceSearchResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => shared.DecoySearchRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/decoys/search")();
  ...
  >(
    M.json(
      200,
      operations.C1ApiDecoyV1DecoySearchServiceSearchResponse$inboundSchema,
      { key: "DecoySearchResponse" },
    ),
