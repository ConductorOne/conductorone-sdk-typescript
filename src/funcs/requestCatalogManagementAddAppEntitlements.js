 ...
 */
export function requestCatalogManagementAddAppEntitlements(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.RequestCatalogManagementServiceAddAppEntitlementsRequest, { explode: true });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiRequestcatalogV1RequestCatalogManagementServiceAddAppEntitlementsResponse$inboundSchema, { key: "RequestCatalogManagementServiceAddAppEntitlementsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
