 ...
 */
export declare function appUsageControlsGet(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppUsageControlsServiceGetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppUsageControlsServiceGetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
