 ...
 */
export async function appAccessRequestsDefaultsCancelAppAccessRequestsDefaults(
...
> {
  ...
  const body = encodeJSON("body", payload.CancelAccessRequestDefaultsRequest, {
    explode: true,
  });
  ...
  const context = {
    operationID:
      "c1.api.app.v1.AppAccessRequestsDefaultsService.CancelAppAccessRequestsDefaults",
    oAuth2Scopes: [],
