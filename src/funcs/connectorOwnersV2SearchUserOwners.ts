...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV2ConnectorOwnersSearchUserOwnersRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc(
    "/api/v2/apps/{app_id}/connectors/{connector_id}/owners/users",
  )(pathParams);
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiAppV2ConnectorOwnersSearchUserOwnersResponse$inboundSchema,
