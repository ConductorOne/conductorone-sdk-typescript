 ...
 */
export function appOwnersListOwnerIDs(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppOwnersListOwnerIDsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/apps/{app_id}/ownerids")(pathParams);
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppOwnersListOwnerIDsResponse$inboundSchema,
      { key: "ListAppOwnerIDsResponse" },
    ),
