 ...
 */
export function appReportActionGenerateReport(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.AppActionsServiceGenerateReportRequest, { explode: true });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppReportActionServiceGenerateReportResponse$inboundSchema, { key: "AppActionsServiceGenerateReportResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
