 ...
 */
export function automationExecutionListAutomationExecutions(client, options) {
...
async function $do(client, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAutomationsV1AutomationExecutionServiceListAutomationExecutionsResponse$inboundSchema, { key: "ListAutomationExecutionsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
