 ...
 */
export declare function taskActionsHardReset(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiTaskV1TaskActionsServiceHardResetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskActionsServiceHardResetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
