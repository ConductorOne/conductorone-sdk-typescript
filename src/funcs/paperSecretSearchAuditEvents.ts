 ...
 */
export function paperSecretSearchAuditEvents(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.PaperSecretServiceSearchAuditEventsRequest$outboundSchema
  ...
  const path = pathToFunc("/api/v1/search/secrets/audit_events")();
  ...
  >(
    M.json(
      ...
      { key: "PaperSecretServiceSearchAuditEventsResponse" },
    ),
