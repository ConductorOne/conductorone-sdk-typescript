 ...
 */
export declare function appAccessRequestsDefaultsCreateAppAccessRequestsDefaults(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppAccessRequestsDefaultsServiceCreateAppAccessRequestsDefaultsRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppAccessRequestsDefaultsServiceCreateAppAccessRequestsDefaultsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
