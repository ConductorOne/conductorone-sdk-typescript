 ...
 */
export declare function appEntitlementsRemoveEntitlementMembership(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppEntitlementsRemoveEntitlementMembershipRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppEntitlementsRemoveEntitlementMembershipResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
