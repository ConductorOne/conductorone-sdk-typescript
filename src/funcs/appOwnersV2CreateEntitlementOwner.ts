 ...
 */
export function appOwnersV2CreateEntitlementOwner(
  client: ConductoroneSDKTypescriptCore,
  request: operations.C1ApiAppV2AppOwnersCreateEntitlementOwnerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiAppV2AppOwnersCreateEntitlementOwnerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV2AppOwnersCreateEntitlementOwnerRequest$outboundSchema
        .parse(value),
