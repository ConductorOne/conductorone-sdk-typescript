 ...
 */
export function appSearchSearchUserOwnership(
  client: ConductoroneSDKTypescriptCore,
  request?: shared.SearchUserOwnershipRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiAppV1AppSearchSearchUserOwnershipResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchUserOwnershipRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/search/user-ownership")();
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppSearchSearchUserOwnershipResponse$inboundSchema,
      { key: "SearchUserOwnershipResponse" },
    ),
