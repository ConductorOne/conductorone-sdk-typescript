...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV2AppOwnersDeleteUserOwnerRequest$outboundSchema.parse(
        value,
      ),
