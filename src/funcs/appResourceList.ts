 ...
 */
export async function appResourceList(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1AppResourceServiceListRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceServiceListResponse$inboundSchema,
      { key: "AppResourceServiceListResponse" },
    ),
