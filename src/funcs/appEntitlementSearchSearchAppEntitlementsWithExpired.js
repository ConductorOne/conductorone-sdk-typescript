 ...
 */
export function appEntitlementSearchSearchAppEntitlementsWithExpired(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/api/v1/apps/{app_id}/entitlements/{app_entitlement_id}/grants")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppEntitlementSearchServiceSearchAppEntitlementsWithExpiredResponse$inboundSchema, { key: "SearchAppEntitlementsWithExpiredResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
