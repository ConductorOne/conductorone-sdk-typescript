 ...
 */
export function appOwnersDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppOwnersDeleteRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DeleteAppOwnersRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.C1ApiAppV1AppOwnersDeleteResponse$inboundSchema, {
      key: "DeleteAppOwnersResponse",
    }),
