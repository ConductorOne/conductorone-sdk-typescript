 ...
 */
export async function appResourceGet(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.C1ApiAppV1AppResourceServiceGetRequest$outboundSchema.parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.C1ApiAppV1AppResourceServiceGetResponse$inboundSchema,
      { key: "AppResourceServiceGetResponse" },
    ),
