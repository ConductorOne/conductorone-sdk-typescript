 ...
 */
export function orgDomainUpdate(
  client: ConductoroneSDKTypescriptCore,
  request?: shared.UpdateOrgDomainRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiSettingsV1OrgDomainServiceUpdateResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.UpdateOrgDomainRequest$outboundSchema.optional().parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiSettingsV1OrgDomainServiceUpdateResponse$inboundSchema,
      { key: "UpdateOrgDomainResponse" },
    ),
