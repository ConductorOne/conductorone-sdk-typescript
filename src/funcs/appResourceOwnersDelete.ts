 ...
 */
export function appResourceOwnersDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppResourceOwnersDeleteRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.DeleteAppResourceOwnersRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceOwnersDeleteResponse$inboundSchema,
      { key: "DeleteAppResourceOwnersResponse" },
    ),
