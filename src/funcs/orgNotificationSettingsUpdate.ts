 ...
 */
export function orgNotificationSettingsUpdate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.UpdateOrgNotificationSettingsRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/settings/notifications/org")();
  ...
  >(
    M.json(
      ...
      { key: "UpdateOrgNotificationSettingsResponse" },
    ),
