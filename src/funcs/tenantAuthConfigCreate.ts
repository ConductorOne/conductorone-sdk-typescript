 ...
 */
export function tenantAuthConfigCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.TenantAuthConfigServiceCreateRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/auth-configs")();
  ...
  >(
    M.json(
      ...
      { key: "TenantAuthConfigServiceCreateResponse" },
    ),
