 ...
 */
export async function connectorForceSync(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1ConnectorServiceForceSyncRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1ConnectorServiceForceSyncResponse$inboundSchema,
      { key: "ForceSyncResponse" },
    ),
