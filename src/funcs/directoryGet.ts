...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiDirectoryV1DirectoryServiceGetRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiDirectoryV1DirectoryServiceGetResponse$inboundSchema,
      { key: "DirectoryServiceGetResponse" },
    ),
