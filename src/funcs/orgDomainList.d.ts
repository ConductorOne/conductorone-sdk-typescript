 ...
 */
export declare function orgDomainList(client: ConductoroneSDKTypescriptCore, request?: operations.C1ApiSettingsV1OrgDomainServiceListRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiSettingsV1OrgDomainServiceListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
