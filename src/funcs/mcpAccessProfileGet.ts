...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .C1ApiAiGovernanceV1MCPAccessProfileServiceGetRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiAiGovernanceV1MCPAccessProfileServiceGetResponse$inboundSchema,
      { key: "MCPAccessProfileServiceGetResponse" },
    ),
