 ...
 */
export function functionsListFunctions(client, options) {
...
async function $do(client, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiFunctionsV1FunctionsServiceListFunctionsResponse$inboundSchema, { key: "FunctionsServiceListFunctionsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
