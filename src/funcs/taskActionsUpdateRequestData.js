 ...
 */
export function taskActionsUpdateRequestData(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.TaskActionsServiceUpdateRequestDataRequest, { explode: true });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/tasks/{task_id}/action/update-request-data")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiTaskV1TaskActionsServiceUpdateRequestDataResponse$inboundSchema, { key: "TaskServiceActionResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
