 ...
 */
export function automationSearchSearchAutomations(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchAutomationsRequest$outboundSchema.optional().parse(value),
  ...
  const context = {
    ...
    operationID:
      "c1.api.automations.v1.AutomationSearchService.SearchAutomations",
    oAuth2Scopes: [],
