 ...
 */
export function mcpAccessProfileToolBindingCreateBindings(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.MCPAccessProfileToolBindingServiceCreateRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      ...
      { key: "MCPAccessProfileToolBindingServiceCreateResponse" },
    ),
