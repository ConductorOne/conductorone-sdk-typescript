 ...
 */
export function requestCatalogManagementUpdateAppEntitlements(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.RequestCatalogManagementServiceUpdateAppEntitlementsRequest,
    { explode: true },
  );
  ...
  const context = {
    ...
    operationID:
      "c1.api.requestcatalog.v1.RequestCatalogManagementService.UpdateAppEntitlements",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "RequestCatalogManagementServiceUpdateAppEntitlementsResponse" },
    ),
