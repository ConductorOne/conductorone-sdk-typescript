...
export function mcpToolList(
  ...
  Result<
    operations.C1ApiAiGovernanceV1MCPToolServiceListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAiGovernanceV1MCPToolServiceListRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAiGovernanceV1MCPToolServiceListResponse$inboundSchema,
      { key: "MCPToolServiceListResponse" },
    ),
