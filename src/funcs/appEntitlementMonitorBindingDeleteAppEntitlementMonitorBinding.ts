 ...
 */
export function appEntitlementMonitorBindingDeleteAppEntitlementMonitorBinding(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.DeleteAppEntitlementMonitorBindingRequest$outboundSchema.optional()
        .parse(value),
  ...
  const context = {
    ...
    operationID:
      "c1.api.accessconflict.v1.AppEntitlementMonitorBindingService.DeleteAppEntitlementMonitorBinding",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "DeleteAppEntitlementMonitorBindingResponse" },
    ),
