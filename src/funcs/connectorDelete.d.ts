 ...
 * Delete a connector.
 */
export declare function connectorDelete(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1ConnectorServiceDeleteRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1ConnectorServiceDeleteResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
