 ...
 */
export function appResourceTypeDeleteManuallyManagedResourceType(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.DeleteManuallyManagedResourceTypeRequest, { explode: true });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppResourceTypeServiceDeleteManuallyManagedResourceTypeResponse$inboundSchema, { key: "DeleteManuallyManagedResourceTypeResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
