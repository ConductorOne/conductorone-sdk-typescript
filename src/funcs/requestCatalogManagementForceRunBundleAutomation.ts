 ...
 */
export async function requestCatalogManagementForceRunBundleAutomation(
...
> {
  ...
  const context = {
    operationID:
      "c1.api.requestcatalog.v1.RequestCatalogManagementService.ForceRunBundleAutomation",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "ForceRunBundleAutomationResponse" },
    ),
