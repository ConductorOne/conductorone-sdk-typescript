 ...
 */
export async function appResourceTypeList(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.C1ApiAppV1AppResourceTypeServiceListRequest$outboundSchema
        .parse(value$),
  ...
  >(
    m$.json(
      200,
      operations.C1ApiAppV1AppResourceTypeServiceListResponse$inboundSchema,
      { key: "AppResourceTypeServiceListResponse" },
    ),
