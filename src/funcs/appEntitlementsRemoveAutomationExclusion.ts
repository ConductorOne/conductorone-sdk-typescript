 ...
 */
export function appEntitlementsRemoveAutomationExclusion(
  client: ConductoroneSDKTypescriptCore,
  request: operations.C1ApiAppV1AppEntitlementsRemoveAutomationExclusionRequest,
...
> {
  ...
  >(
    M.json(
      ...
      { key: "RemoveAutomationExclusionResponse" },
    ),
