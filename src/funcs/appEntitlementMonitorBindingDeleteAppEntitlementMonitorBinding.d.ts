 ...
 */
export declare function appEntitlementMonitorBindingDeleteAppEntitlementMonitorBinding(client: ConductoroneSDKTypescriptCore, request?: shared.DeleteAppEntitlementMonitorBindingRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAccessconflictV1AppEntitlementMonitorBindingServiceDeleteAppEntitlementMonitorBindingResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
