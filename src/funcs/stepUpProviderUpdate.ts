 ...
 */
export function stepUpProviderUpdate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiStepupV1StepUpProviderServiceUpdateRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiStepupV1StepUpProviderServiceUpdateResponse$inboundSchema,
      { key: "UpdateStepUpProviderResponse" },
    ),
