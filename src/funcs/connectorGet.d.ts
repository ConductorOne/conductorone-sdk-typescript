 ...
 * Get a connector.
 */
export declare function connectorGet(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1ConnectorServiceGetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1ConnectorServiceGetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
