 ...
 */
export declare function appUserListAppUserCredentials(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppUserServiceListAppUserCredentialsRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppUserServiceListAppUserCredentialsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
