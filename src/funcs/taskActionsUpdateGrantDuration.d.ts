 ...
 */
export declare function taskActionsUpdateGrantDuration(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiTaskV1TaskActionsServiceUpdateGrantDurationRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskActionsServiceUpdateGrantDurationResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
