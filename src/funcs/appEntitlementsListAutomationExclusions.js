 ...
 */
export function appEntitlementsListAutomationExclusions(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppEntitlementsListAutomationExclusionsResponse$inboundSchema, { key: "ListAutomationExclusionsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
