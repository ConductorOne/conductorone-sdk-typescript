 ...
 */
export function functionsInvoke(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiFunctionsV1FunctionsServiceInvokeRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiFunctionsV1FunctionsServiceInvokeResponse$inboundSchema,
      { key: "FunctionsServiceInvokeResponse" },
    ),
