 ...
 */
export function userGetUserProfileTypes(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiUserV1UserServiceGetUserProfileTypesRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/users/{user_id}/profile-types")(pathParams);
  ...
  >(
    M.json(
      ...
      { key: "GetUserProfileTypesResponse" },
    ),
