 ...
 */
export declare function webhooksList(client: ConductoroneSDKTypescriptCore, request?: operations.C1ApiWebhooksV1WebhooksServiceListRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiWebhooksV1WebhooksServiceListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
