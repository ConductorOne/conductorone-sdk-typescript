 ...
 */
export declare function appResourceOwnersAdd(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppResourceOwnersAddRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppResourceOwnersAddResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
