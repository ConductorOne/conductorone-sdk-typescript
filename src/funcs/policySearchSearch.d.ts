 ...
 */
export declare function policySearchSearch(client: ConductoroneSDKTypescriptCore, request?: shared.SearchPoliciesRequest | undefined, options?: RequestOptions): APIPromise<PageIterator<Result<operations.C1ApiPolicyV1PolicySearchSearchResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>, {
    cursor: string;
}>>;
