 ...
 */
export declare function attributesGetComplianceFrameworkAttributeValue(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAttributeV1AttributesGetComplianceFrameworkAttributeValueRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAttributeV1AttributesGetComplianceFrameworkAttributeValueResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
