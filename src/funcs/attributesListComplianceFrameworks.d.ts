 ...
 */
export declare function attributesListComplianceFrameworks(client: ConductoroneSDKTypescriptCore, request?: operations.C1ApiAttributeV1AttributesListComplianceFrameworksRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAttributeV1AttributesListComplianceFrameworksResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
