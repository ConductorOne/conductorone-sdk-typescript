...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiHooksV1HooksServiceGetRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.C1ApiHooksV1HooksServiceGetResponse$inboundSchema, {
      key: "HooksServiceGetResponse",
    }),
