 ...
 */
export declare function appEntitlementUserBindingSearchGrantFeed(client: ConductoroneSDKTypescriptCore, request?: shared.SearchGrantFeedRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppEntitlementUserBindingServiceSearchGrantFeedResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
