 ...
 */
export function ssfReceiverEventSearchSearch(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SSFReceiverEventSearchServiceSearchRequest$outboundSchema
  ...
  const path = pathToFunc("/api/v1/search/ssf-receiver-events")();
  ...
  >(
    M.json(
      ...
      { key: "SSFReceiverEventSearchServiceSearchResponse" },
    ),
