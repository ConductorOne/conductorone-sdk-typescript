 ...
 */
export declare function automationExecutionListAutomationExecutions(client: ConductoroneSDKTypescriptCore, options?: RequestOptions): APIPromise<Result<operations.C1ApiAutomationsV1AutomationExecutionServiceListAutomationExecutionsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
