 ...
 */
export function roleMiningManagementCreateAccessProfileFromCohort(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.CreateAccessProfileFromCohortRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/role-mining/access-profiles")();
  ...
  >(
    M.json(
      ...
      { key: "CreateAccessProfileFromCohortResponse" },
    ),
