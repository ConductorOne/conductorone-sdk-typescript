 ...
 */
export function appEntitlementOwnersDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppEntitlementOwnersDeleteRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.DeleteAppEntitlementOwnersRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppEntitlementOwnersDeleteResponse$inboundSchema,
      { key: "DeleteAppEntitlementOwnersResponse" },
    ),
