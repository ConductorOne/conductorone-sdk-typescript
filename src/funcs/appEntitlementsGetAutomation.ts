 ...
 */
export function appEntitlementsGetAutomation(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppEntitlementsGetAutomationRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppEntitlementsGetAutomationResponse$inboundSchema,
      { key: "AppEntitlementServiceGetAutomationResponse" },
    ),
