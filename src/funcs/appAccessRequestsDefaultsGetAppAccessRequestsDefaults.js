 ...
 */
export function appAccessRequestsDefaultsGetAppAccessRequestsDefaults(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAppV1AppAccessRequestsDefaultsServiceGetAppAccessRequestsDefaultsResponse$inboundSchema, { key: "AppAccessRequestDefaults" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
