 ...
 */
export function decoyList(
  client: ConductoroneSDKTypescriptCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiDecoyV1DecoyServiceListResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.C1ApiDecoyV1DecoyServiceListResponse$inboundSchema, {
      key: "DecoyServiceListResponse",
    }),
