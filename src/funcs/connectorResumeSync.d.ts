 ...
 */
export declare function connectorResumeSync(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1ConnectorServiceResumeSyncRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1ConnectorServiceResumeSyncResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
