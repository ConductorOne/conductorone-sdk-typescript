 ...
 */
export function tenantEmailProviderTest(
  client: ConductoroneSDKTypescriptCore,
  request?: shared.TestTenantEmailProviderRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiSettingsV1TenantEmailProviderServiceTestResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.TestTenantEmailProviderRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/settings/email-provider/test")();
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiSettingsV1TenantEmailProviderServiceTestResponse$inboundSchema,
      { key: "TestTenantEmailProviderResponse" },
    ),
