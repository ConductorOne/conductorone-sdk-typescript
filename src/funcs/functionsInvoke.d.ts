 ...
 */
export declare function functionsInvoke(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiFunctionsV1FunctionsServiceInvokeRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiFunctionsV1FunctionsServiceInvokeResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
