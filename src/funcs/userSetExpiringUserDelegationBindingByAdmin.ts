...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.SetExpiringUserDelegationBindingByAdminRequest,
    { explode: true },
  );
  ...
  const context = {
    ...
    operationID:
      "c1.api.user.v1.UserService.SetExpiringUserDelegationBindingByAdmin",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "SetExpiringUserDelegationBindingByAdminResponse" },
    ),
