 ...
 */
export function appEntitlementsProxyGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppEntitlementsProxyGetRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppEntitlementsProxyGetResponse$inboundSchema,
      { key: "GetAppEntitlementProxyResponse" },
    ),
