...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.FindingAuditServiceSearchRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/search/finding_audits")();
  ...
  >(
    M.json(
      200,
      operations.C1ApiFindingV1FindingAuditServiceSearchResponse$inboundSchema,
      { key: "FindingAuditServiceSearchResponse" },
    ),
