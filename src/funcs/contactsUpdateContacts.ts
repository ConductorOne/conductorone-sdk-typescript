 ...
 */
export function contactsUpdateContacts(
  client: ConductoroneSDKTypescriptCore,
  request?: shared.UpdateContactsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiSettingsV1ContactsServiceUpdateContactsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.UpdateContactsRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v1/settings/contacts")();
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiSettingsV1ContactsServiceUpdateContactsResponse$inboundSchema,
      { key: "UpdateContactsResponse" },
    ),
