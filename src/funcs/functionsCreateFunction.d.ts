 ...
 */
export declare function functionsCreateFunction(client: ConductoroneSDKTypescriptCore, request?: shared.FunctionsServiceCreateFunctionRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiFunctionsV1FunctionsServiceCreateFunctionResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
