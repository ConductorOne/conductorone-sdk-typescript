 ...
 */
export function taskActionsClose(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiTaskV1TaskActionsServiceCloseRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiTaskV1TaskActionsServiceCloseResponse$inboundSchema,
      { key: "TaskActionsServiceCloseResponse" },
    ),
