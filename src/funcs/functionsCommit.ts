...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiFunctionsV1FunctionsServiceCommitRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiFunctionsV1FunctionsServiceCommitResponse$inboundSchema,
      { key: "FunctionsServiceCommitResponse" },
    ),
