 ...
 */
export async function connectorRotateCredential(
...
> {
  ...
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .C1ApiAppV1ConnectorServiceRotateCredentialRequest$outboundSchema.parse(
          value,
        ),
  ...
  const body = encodeJSON(
    "body",
    payload.ConnectorServiceRotateCredentialRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      ...
      { key: "ConnectorServiceRotateCredentialResponse" },
    ),
