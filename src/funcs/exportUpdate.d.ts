 ...
 */
export declare function exportUpdate(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiSystemlogV1ExportServiceUpdateRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiSystemlogV1ExportServiceUpdateResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
