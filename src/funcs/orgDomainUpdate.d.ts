 ...
 */
export declare function orgDomainUpdate(client: ConductoroneSDKTypescriptCore, request?: shared.UpdateOrgDomainRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiSettingsV1OrgDomainServiceUpdateResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
