 ...
 */
export declare function appEntitlementSearchSearchGrants(client: ConductoroneSDKTypescriptCore, request?: shared.AppEntitlementSearchServiceSearchGrantsRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppEntitlementSearchServiceSearchGrantsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
