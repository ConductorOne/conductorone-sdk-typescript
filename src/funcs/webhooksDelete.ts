...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiWebhooksV1WebhooksServiceDeleteRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiWebhooksV1WebhooksServiceDeleteResponse$inboundSchema,
      { key: "WebhooksServiceDeleteResponse" },
    ),
