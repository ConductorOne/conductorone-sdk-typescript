...
export function hooksList(
  ...
  Result<
    operations.C1ApiHooksV1HooksServiceListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiHooksV1HooksServiceListRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/hooks")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.C1ApiHooksV1HooksServiceListResponse$inboundSchema, {
      key: "HooksServiceListResponse",
    }),
