...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiWebhooksV1WebhooksServiceUpdateRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiWebhooksV1WebhooksServiceUpdateResponse$inboundSchema,
      { key: "WebhooksServiceUpdateResponse" },
    ),
