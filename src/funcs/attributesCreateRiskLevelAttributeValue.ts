 ...
 */
export function attributesCreateRiskLevelAttributeValue(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.CreateRiskLevelAttributeValueRequest$outboundSchema.optional()
        .parse(value),
  ...
  >(
    M.json(
      ...
      { key: "CreateRiskLevelAttributeValueResponse" },
    ),
