...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiDecoyV1DecoyServiceUpdateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.DecoyServiceUpdateRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiDecoyV1DecoyServiceUpdateResponse$inboundSchema,
