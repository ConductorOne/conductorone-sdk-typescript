 ...
 */
export declare function functionsCreateTag(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiFunctionsV1FunctionsServiceCreateTagRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiFunctionsV1FunctionsServiceCreateTagResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
