 ...
 */
export declare function appOwnersAdd(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppOwnersAddRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppOwnersAddResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
