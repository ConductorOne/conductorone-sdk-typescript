 ...
 */
export function stepUpProviderTest(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiStepupV1StepUpProviderServiceTestRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiStepupV1StepUpProviderServiceTestResponse$inboundSchema,
      { key: "TestStepUpProviderResponse" },
    ),
