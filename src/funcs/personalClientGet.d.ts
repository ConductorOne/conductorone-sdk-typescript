 ...
 */
export declare function personalClientGet(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiIamV1PersonalClientServiceGetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiIamV1PersonalClientServiceGetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
