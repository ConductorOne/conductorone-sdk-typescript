 ...
 */
export declare function appOwnersSet(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppOwnersSetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppOwnersSetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
