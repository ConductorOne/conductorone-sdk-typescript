 ...
 */
export declare function appResourceOwnersRemove(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppResourceOwnersRemoveRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppResourceOwnersRemoveResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
