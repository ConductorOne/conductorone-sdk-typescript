 ...
 */
export function requestSchemaDelete(
...
> {
  ...
  const body = encodeJSON("body", payload.RequestSchemaServiceDeleteRequest, {
    explode: true,
  });

  const pathParams = {
    request_schema_id: encodeSimple(
      "request_schema_id",
      payload.request_schema_id,
  ...
  >(
    M.json(
      ...
      { key: "RequestSchemaServiceDeleteResponse" },
    ),
