 ...
 */
export declare function functionsListFunctions(client: ConductoroneSDKTypescriptCore, options?: RequestOptions): APIPromise<Result<operations.C1ApiFunctionsV1FunctionsServiceListFunctionsResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
