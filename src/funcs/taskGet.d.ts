 ...
 * Get a task by ID
 */
export declare function taskGet(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiTaskV1TaskServiceGetRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiTaskV1TaskServiceGetResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
