 ...
 */
export function requestCatalogManagementRemoveAccessEntitlements(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.RequestCatalogManagementServiceRemoveAccessEntitlementsRequest, { explode: true });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        ...
        key: "RequestCatalogManagementServiceRemoveAccessEntitlementsResponse",
