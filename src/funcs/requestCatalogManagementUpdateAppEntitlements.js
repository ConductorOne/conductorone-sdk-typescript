 ...
 */
export function requestCatalogManagementUpdateAppEntitlements(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.RequestCatalogManagementServiceUpdateAppEntitlementsRequest, { explode: true });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/catalogs/{catalog_id}/requestable_entitlements/update")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiRequestcatalogV1RequestCatalogManagementServiceUpdateAppEntitlementsResponse$inboundSchema, { key: "RequestCatalogManagementServiceUpdateAppEntitlementsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
