 ...
 */
export function accessReviewTemplateCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.AccessReviewTemplateServiceCreateRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/access_review_template")();
  ...
  >(
    M.json(
      ...
      { key: "AccessReviewTemplateServiceCreateResponse" },
    ),
