...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiSettingsV1OrgDomainServiceListRequest$outboundSchema
  ...
  >(
    M.json(
      200,
      operations.C1ApiSettingsV1OrgDomainServiceListResponse$inboundSchema,
      { key: "ListOrgDomainsResponse" },
    ),
