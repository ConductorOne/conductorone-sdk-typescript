 ...
 */
export function appResourceOwnersListOwnerIDs(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppResourceOwnersListOwnerIDsRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceOwnersListOwnerIDsResponse$inboundSchema,
      { key: "ListAppResourceOwnerIDsResponse" },
    ),
