 ...
 */
export function requestCatalogManagementResumePausedBundleAutomation(
...
> {
  ...
  const context = {
    ...
    operationID:
      "c1.api.requestcatalog.v1.RequestCatalogManagementService.ResumePausedBundleAutomation",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "ResumePausedBundleAutomationResponse" },
    ),
