 ...
 */
export declare function functionsSearchSearch(client: ConductoroneSDKTypescriptCore, request?: shared.FunctionsSearchRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiFunctionsV1FunctionsSearchSearchResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
