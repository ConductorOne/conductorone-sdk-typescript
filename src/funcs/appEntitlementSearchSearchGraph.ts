 ...
 */
export function appEntitlementSearchSearchGraph(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.AppEntitlementSearchServiceSearchGraphRequest$outboundSchema
  ...
  const path = pathToFunc("/api/v1/search/graph")();
  ...
  >(
    M.json(
      ...
      { key: "AppEntitlementSearchServiceSearchGraphResponse" },
    ),
