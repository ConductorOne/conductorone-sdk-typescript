 ...
 */
export declare function connectorUpdateDelegated(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1ConnectorServiceUpdateDelegatedRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1ConnectorServiceUpdateDelegatedResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
