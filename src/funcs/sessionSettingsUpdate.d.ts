 ...
 */
export declare function sessionSettingsUpdate(client: ConductoroneSDKTypescriptCore, request?: shared.UpdateSessionSettingsRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiSettingsV1SessionSettingsServiceUpdateResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
