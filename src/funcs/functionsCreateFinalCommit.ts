 ...
 */
export function functionsCreateFinalCommit(
  client: ConductoroneSDKTypescriptCore,
  request: operations.C1ApiFunctionsV1FunctionsServiceCreateFinalCommitRequest,
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.FunctionsServiceCreateFinalCommitRequest,
    { explode: true },
  );

  const pathParams = {
    commit_id: encodeSimple("commit_id", payload.commit_id, {
      explode: false,
  ...
  >(
    M.json(
      ...
      { key: "FunctionsServiceCreateFinalCommitResponse" },
    ),
