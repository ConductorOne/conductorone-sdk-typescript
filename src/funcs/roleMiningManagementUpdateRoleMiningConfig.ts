 ...
 */
export function roleMiningManagementUpdateRoleMiningConfig(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.UpdateRoleMiningConfigRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/role-mining/config")();
  ...
  >(
    M.json(
      ...
      { key: "UpdateRoleMiningConfigResponse" },
    ),
