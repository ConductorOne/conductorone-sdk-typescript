...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.SearchAutomationTemplateVersionsRequest$outboundSchema.optional()
        .parse(value),
  ...
  const context = {
    ...
    operationID:
      "c1.api.automations.v1.AutomationSearchService.SearchAutomationTemplateVersions",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "SearchAutomationTemplateVersionsResponse" },
    ),
