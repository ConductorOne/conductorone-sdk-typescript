 ...
 * Delete an app.
 */
export declare function appsDelete(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppsDeleteRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppsDeleteResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
