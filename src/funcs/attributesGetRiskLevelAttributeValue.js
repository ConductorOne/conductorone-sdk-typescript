 ...
 */
export function attributesGetRiskLevelAttributeValue(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAttributeV1AttributesGetRiskLevelAttributeValueResponse$inboundSchema, { key: "GetRiskLevelAttributeValueResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
