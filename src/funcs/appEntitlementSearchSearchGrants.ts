 ...
 */
export function appEntitlementSearchSearchGrants(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.AppEntitlementSearchServiceSearchGrantsRequest$outboundSchema
  ...
  >(
    M.json(
      ...
      { key: "AppEntitlementSearchServiceSearchGrantsResponse" },
    ),
