 ...
 */
export async function connectorUpdateDelegated(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.C1ApiAppV1ConnectorServiceUpdateDelegatedRequest$outboundSchema
        .parse(value$),
  ...
  const body$ = encodeJSON$(
    "body",
    payload$.ConnectorServiceUpdateDelegatedRequest,
    { explode: true },
  );

  const pathParams$ = {
    connector_app_id: encodeSimple$(
      "connector_app_id",
      payload$.connector_app_id,
