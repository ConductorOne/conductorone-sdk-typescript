 ...
 */
export function paperSecretSearchMySecrets(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.PaperSecretServiceSearchMySecretsRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/search/secrets/mine")();
  ...
  >(
    M.json(
      ...
      { key: "PaperSecretServiceSearchResponse" },
    ),
