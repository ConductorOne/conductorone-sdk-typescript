 ...
 */
export function mcpAccessProfileToolBindingList(
...
> {
  ...
  const context = {
    ...
    operationID:
      "c1.api.ai_governance.v1.MCPAccessProfileToolBindingService.List",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "MCPAccessProfileToolBindingServiceListResponse" },
    ),
