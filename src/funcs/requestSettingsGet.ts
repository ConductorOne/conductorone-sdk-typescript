 ...
 */
export function requestSettingsGet(
  client: ConductoroneSDKTypescriptCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiSettingsV1RequestSettingsServiceGetResponse,
...
> {
  ...
  const context = {
    ...
    operationID: "c1.api.settings.v1.RequestSettingsService.Get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.C1ApiSettingsV1RequestSettingsServiceGetResponse$inboundSchema,
      { key: "GetRequestSettingsResponse" },
    ),
