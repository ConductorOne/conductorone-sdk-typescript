 ...
 */
export function connectorCatalogConfigurationSchema(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.ConnectorCatalogServiceConfigurationSchemaRequest$outboundSchema
  ...
  const path = pathToFunc("/api/v1/connectorcatalog")();
  ...
  >(
    M.json(
      ...
      { key: "ConnectorCatalogServiceConfigurationSchemaResponse" },
    ),
