 ...
 */
export function aiGovernanceSettingsGetTenantDefaults(
...
> {
  const path = pathToFunc("/api/v1/settings/ai-governance/tenant-defaults")();
  ...
  const context = {
    ...
    operationID:
      "c1.api.ai_governance.v1.AIGovernanceSettingsService.GetTenantDefaults",
    oAuth2Scopes: null,
