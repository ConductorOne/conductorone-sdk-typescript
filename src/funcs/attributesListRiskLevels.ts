 ...
 */
export function attributesListRiskLevels(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAttributeV1AttributesListRiskLevelsRequest$outboundSchema
  ...
  >(
    M.json(
      200,
      operations.C1ApiAttributeV1AttributesListRiskLevelsResponse$inboundSchema,
      { key: "ListRiskLevelsResponse" },
    ),
