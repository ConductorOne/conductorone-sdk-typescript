 ...
 */
export async function appResourceUpdate(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1AppResourceServiceUpdateRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceServiceUpdateResponse$inboundSchema,
      { key: "AppResourceServiceUpdateResponse" },
    ),
