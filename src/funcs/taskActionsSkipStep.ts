 ...
 */
export function taskActionsSkipStep(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiTaskV1TaskActionsServiceSkipStepRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/api/v1/tasks/{task_id}/action/skip-step")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.C1ApiTaskV1TaskActionsServiceSkipStepResponse$inboundSchema,
      { key: "TaskServiceActionResponse" },
    ),
