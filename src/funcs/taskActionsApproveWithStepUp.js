 ...
 */
export function taskActionsApproveWithStepUp(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.TaskActionsServiceApproveWithStepUpRequest, { explode: true });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/tasks/{task_id}/action/approve-with-step-up")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiTaskV1TaskActionsServiceApproveWithStepUpResponse$inboundSchema, { key: "TaskActionsServiceApproveWithStepUpResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
