 ...
 */
export function mcpAccessProfileCreate(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.MCPAccessProfileServiceCreateRequest,
    { explode: true },
  );
  ...
  const path = pathToFunc(
    "/api/v1/apps/{app_id}/connectors/{connector_id}/mcp_toolsets",
  )(pathParams);
  ...
  >(
    M.json(
      ...
      { key: "MCPAccessProfileServiceCreateResponse" },
    ),
