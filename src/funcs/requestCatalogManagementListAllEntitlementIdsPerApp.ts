 ...
 */
export function requestCatalogManagementListAllEntitlementIdsPerApp(
...
> {
  ...
  const context = {
    ...
    operationID:
      "c1.api.requestcatalog.v1.RequestCatalogManagementService.ListAllEntitlementIdsPerApp",
    oAuth2Scopes: null,
