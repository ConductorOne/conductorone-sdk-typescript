 ...
 */
export function stepUpProviderUpdateSecret(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.UpdateStepUpProviderSecretRequest, {
        explode: true,
    });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/step-up/providers/{id}/secret")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiStepupV1StepUpProviderServiceUpdateSecretResponse$inboundSchema, { key: "UpdateStepUpProviderSecretResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
