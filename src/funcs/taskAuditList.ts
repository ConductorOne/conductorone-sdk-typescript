...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.TaskAuditListRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.C1ApiTaskV1TaskAuditListResponse$inboundSchema, {
