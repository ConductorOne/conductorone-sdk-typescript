...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      shared.WebhooksServiceCreateRequest$outboundSchema.optional().parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.C1ApiWebhooksV1WebhooksServiceCreateResponse$inboundSchema,
      { key: "WebhooksServiceCreateResponse" },
    ),
