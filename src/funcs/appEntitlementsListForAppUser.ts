 ...
 */
export async function appEntitlementsListForAppUser(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.C1ApiAppV1AppEntitlementsListForAppUserRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppEntitlementsListForAppUserResponse$inboundSchema,
