 ...
 */
export declare function sessionSettingsTestSourceIP(client: ConductoroneSDKTypescriptCore, request?: shared.TestSourceIPRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiSettingsV1SessionSettingsServiceTestSourceIPResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
