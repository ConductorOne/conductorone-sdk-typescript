 ...
 */
export declare function appEntitlementsProxyDelete(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAppV1AppEntitlementsProxyDeleteRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppEntitlementsProxyDeleteResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
