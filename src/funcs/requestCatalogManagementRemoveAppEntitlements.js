 ...
 */
export function requestCatalogManagementRemoveAppEntitlements(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.RequestCatalogManagementServiceRemoveAppEntitlementsRequest, { explode: true });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/catalogs/{catalog_id}/requestable_entries")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiRequestcatalogV1RequestCatalogManagementServiceRemoveAppEntitlementsResponse$inboundSchema, { key: "RequestCatalogManagementServiceRemoveAppEntitlementsResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
