 ...
 */
export async function appResourceCreateManuallyManagedAppResource(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.CreateManuallyManagedAppResourceRequest,
    { explode: true },
  );
  ...
  const context = {
    operationID:
      "c1.api.app.v1.AppResourceService.CreateManuallyManagedAppResource",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "CreateManuallyManagedAppResourceResponse" },
    ),
