 ...
 */
export function aiGovernanceSettingsUpdate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.UpdateAIGovernanceSettingsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/settings/ai-governance")();
  ...
  >(
    M.json(
      ...
      { key: "UpdateAIGovernanceSettingsResponse" },
    ),
