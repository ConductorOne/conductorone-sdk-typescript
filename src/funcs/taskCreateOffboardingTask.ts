 ...
 */
export async function taskCreateOffboardingTask(
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      shared.TaskServiceCreateOffboardingRequest$outboundSchema.optional()
        .parse(value),
  ...
  >(
    M.json(
      ...
      { key: "TaskServiceCreateOffboardingResponse" },
    ),
