...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV2AppOwnersCreateUserOwnerRequest$outboundSchema.parse(
        value,
      ),
