 ...
 */
export function automationResolvePausedAutomationExecutions(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.ResolvePausedAutomationExecutionsRequest,
    { explode: true },
  );
  ...
  >(
    M.json(
      ...
      { key: "ResolvePausedAutomationExecutionsResponse" },
    ),
