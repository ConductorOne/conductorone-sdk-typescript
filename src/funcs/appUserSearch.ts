...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.AppUserServiceSearchRequest$outboundSchema.optional().parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppUserServiceSearchResponse$inboundSchema,
      { key: "AppUserServiceSearchResponse" },
    ),
