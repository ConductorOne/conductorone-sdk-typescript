...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.C1ApiWebhooksV1WebhooksServiceGetRequest$outboundSchema.parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.C1ApiWebhooksV1WebhooksServiceGetResponse$inboundSchema,
      { key: "WebhooksServiceGetResponse" },
    ),
