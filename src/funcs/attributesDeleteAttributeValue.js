 ...
 */
export function attributesDeleteAttributeValue(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.DeleteAttributeValueRequest, {
        explode: true,
    });
    const pathParams = {
    ...
    const path = pathToFunc("/api/v1/attribute/{id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAttributeV1AttributesDeleteAttributeValueResponse$inboundSchema, { key: "DeleteAttributeValueResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
