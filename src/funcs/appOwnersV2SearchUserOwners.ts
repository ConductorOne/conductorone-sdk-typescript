...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV2AppOwnersSearchUserOwnersRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/api/v2/apps/{app_id}/owners/users")(pathParams);
