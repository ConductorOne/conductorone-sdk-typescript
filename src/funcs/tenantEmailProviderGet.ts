 ...
 */
export function tenantEmailProviderGet(
  client: ConductoroneSDKTypescriptCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.C1ApiSettingsV1TenantEmailProviderServiceGetResponse,
...
> {
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiSettingsV1TenantEmailProviderServiceGetResponse$inboundSchema,
      { key: "GetTenantEmailProviderResponse" },
    ),
