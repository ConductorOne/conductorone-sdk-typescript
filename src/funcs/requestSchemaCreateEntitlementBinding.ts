...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.RequestSchemaServiceCreateEntitlementBindingRequest$outboundSchema
  ...
  const path = pathToFunc("/api/v1/request_schema_entitlement_binding")();
  ...
  const context = {
    ...
    operationID:
      "c1.api.request_schema.v1.RequestSchemaService.CreateEntitlementBinding",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "RequestSchemaServiceCreateEntitlementBindingResponse" },
    ),
