 ...
 */
export function stepUpProviderCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      shared.CreateStepUpProviderRequest$outboundSchema.optional().parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiStepupV1StepUpProviderServiceCreateResponse$inboundSchema,
      { key: "CreateStepUpProviderResponse" },
    ),
