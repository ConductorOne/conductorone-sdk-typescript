 ...
 */
export function attributesDeleteRiskLevelAttributeValue(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const body = encodeJSON("body", payload.DeleteRiskLevelAttributeValueRequest, { explode: true });
    const pathParams = {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiAttributeV1AttributesDeleteRiskLevelAttributeValueResponse$inboundSchema, { key: "DeleteRiskLevelAttributeValueResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
