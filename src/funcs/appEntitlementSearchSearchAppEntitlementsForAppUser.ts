 ...
 */
export async function appEntitlementSearchSearchAppEntitlementsForAppUser(
...
> {
  ...
  const context = {
    operationID:
      "c1.api.app.v1.AppEntitlementSearchService.SearchAppEntitlementsForAppUser",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "ListAppEntitlementsResponse" },
    ),
