 ...
 */
export function appEntitlementsListAutomationExclusions(
  client: ConductoroneSDKTypescriptCore,
  request: operations.C1ApiAppV1AppEntitlementsListAutomationExclusionsRequest,
...
> {
  ...
  >(
    M.json(
      ...
      { key: "ListAutomationExclusionsResponse" },
    ),
