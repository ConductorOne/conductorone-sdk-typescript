 ...
 */
export function requestCatalogManagementListAllEntitlementIdsPerApp(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/api/v1/catalogs/{catalog_id}/requestable_entitlementIDs")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        ...
        key: "RequestCatalogManagementServiceListAllEntitlementIdsPerCatalogResponse",
