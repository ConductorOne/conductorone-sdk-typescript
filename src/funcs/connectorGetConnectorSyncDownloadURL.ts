 ...
 */
export function connectorGetConnectorSyncDownloadURL(
...
> {
  ...
  const pathParams = {
    ...
    sync_id: encodeSimple("sync_id", payload.sync_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const path = pathToFunc(
    "/api/v1/apps/{app_id}/connectors/{connector_id}/syncs/{sync_id}/download_url",
  )(pathParams);
  ...
  const context = {
    ...
    operationID: "c1.api.app.v1.ConnectorService.GetConnectorSyncDownloadURL",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "GetConnectorSyncDownloadURLResponse" },
    ),
