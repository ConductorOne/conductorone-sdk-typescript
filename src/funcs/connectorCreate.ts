...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1ConnectorServiceCreateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/apps/{app_id}/connectors/create")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1ConnectorServiceCreateResponse$inboundSchema,
      { key: "ConnectorServiceCreateResponse" },
    ),
