...
> {
  const parsed = safeParse(
    ...
    (value) =>
      operations
        .C1ApiAiGovernanceV1MCPToolServiceListHistoryRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations
        .C1ApiAiGovernanceV1MCPToolServiceListHistoryResponse$inboundSchema,
      { key: "MCPToolServiceListHistoryResponse" },
    ),
