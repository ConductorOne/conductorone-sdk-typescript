 ...
 */
export function authIntrospect(client, options) {
    return new APIPromise($do(client, options));
}
async function $do(client, options) {
    const path = pathToFunc("/api/v1/auth/introspect")();
    ...
    const [result] = await M.match(M.json(200, operations.C1ApiAuthV1AuthIntrospectResponse$inboundSchema, {
        key: "IntrospectResponse",
