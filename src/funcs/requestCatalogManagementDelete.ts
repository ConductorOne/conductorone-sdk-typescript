 ...
 * Delete a catalog.
 */
export async function requestCatalogManagementDelete(
...
> {
  ...
  const context = {
    operationID:
      "c1.api.requestcatalog.v1.RequestCatalogManagementService.Delete",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      ...
      { key: "RequestCatalogManagementServiceDeleteResponse" },
    ),
