 ...
 */
export function requestCatalogManagementDeleteRequestableEntry(
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.RequestCatalogManagementServiceDeleteRequestableEntryRequest,
    { explode: true },
  );
  ...
  const context = {
    ...
    operationID:
      "c1.api.requestcatalog.v1.RequestCatalogManagementService.DeleteRequestableEntry",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "RequestCatalogManagementServiceDeleteRequestableEntryResponse" },
    ),
