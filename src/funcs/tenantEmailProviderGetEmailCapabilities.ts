 ...
 */
export function tenantEmailProviderGetEmailCapabilities(
...
> {
  const path = pathToFunc("/api/v1/settings/email-capabilities")();
  ...
  const context = {
    ...
    operationID:
      "c1.api.settings.v1.TenantEmailProviderService.GetEmailCapabilities",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      ...
      { key: "GetEmailCapabilitiesResponse" },
    ),
