 ...
 */
export function connectorPauseSync(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1ConnectorServicePauseSyncRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1ConnectorServicePauseSyncResponse$inboundSchema,
      { key: "PauseSyncResponse" },
    ),
