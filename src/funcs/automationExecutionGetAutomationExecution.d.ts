 ...
 */
export declare function automationExecutionGetAutomationExecution(client: ConductoroneSDKTypescriptCore, request: operations.C1ApiAutomationsV1AutomationExecutionServiceGetAutomationExecutionRequest, options?: RequestOptions): APIPromise<Result<operations.C1ApiAutomationsV1AutomationExecutionServiceGetAutomationExecutionResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
