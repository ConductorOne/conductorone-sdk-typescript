 ...
 */
export function connectorUpdateConnectorSchedule(
  client: ConductoroneSDKTypescriptCore,
  request: operations.C1ApiAppV1ConnectorServiceUpdateConnectorScheduleRequest,
...
> {
  ...
  const body = encodeJSON("body", payload.UpdateConnectorScheduleRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      ...
      { key: "UpdateConnectorScheduleResponse" },
    ),
