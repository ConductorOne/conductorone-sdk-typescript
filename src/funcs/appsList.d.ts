 ...
 * List all apps.
 */
export declare function appsList(client: ConductoroneSDKTypescriptCore, request?: operations.C1ApiAppV1AppsListRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppsListResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
