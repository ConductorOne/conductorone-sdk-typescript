...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAiGovernanceV1MCPToolServiceUpdateRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.MCPToolServiceUpdateRequest, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.C1ApiAiGovernanceV1MCPToolServiceUpdateResponse$inboundSchema,
      { key: "MCPToolServiceUpdateResponse" },
    ),
