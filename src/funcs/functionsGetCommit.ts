...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiFunctionsV1FunctionsServiceGetCommitRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      ...
      { key: "FunctionsServiceGetCommitResponse" },
    ),
