 ...
 */
export function appResourceOwnersAdd(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.C1ApiAppV1AppResourceOwnersAddRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.C1ApiAppV1AppResourceOwnersAddResponse$inboundSchema,
      { key: "AddAppResourceOwnerResponse" },
    ),
