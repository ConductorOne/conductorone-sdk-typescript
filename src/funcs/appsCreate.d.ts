 ...
 */
export declare function appsCreate(client: ConductoroneSDKTypescriptCore, request?: shared.CreateAppRequest | undefined, options?: RequestOptions): APIPromise<Result<operations.C1ApiAppV1AppsCreateResponse, ConductoroneSDKTypescriptError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
