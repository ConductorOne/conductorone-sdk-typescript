 ...
 */
export function requestCatalogManagementList(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .C1ApiRequestcatalogV1RequestCatalogManagementServiceListResponse$inboundSchema, { key: "RequestCatalogManagementServiceListResponse" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
